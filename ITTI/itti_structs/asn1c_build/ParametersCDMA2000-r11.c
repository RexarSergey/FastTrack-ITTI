...
static asn_oer_constraints_t asn_OER_type_systemTimeInfo_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_csfb_DualRxTxSupport_r11_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_longCodeState1XRTT_r11_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	42	/* (SIZE(42..42)) */};
...
static asn_oer_constraints_t asn_OER_memb_searchWindowSize_r11_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_systemTimeInfo_r11_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_systemTimeInfo_r11_constr_2, &asn_PER_type_systemTimeInfo_r11_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_csfb_DualRxTxSupport_r11_16 = {
	...
	{ &asn_OER_type_csfb_DualRxTxSupport_r11_constr_16, &asn_PER_type_csfb_DualRxTxSupport_r11_constr_16, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_parameters1XRTT_r11_9[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct ParametersCDMA2000_r11__parameters1XRTT_r11, longCodeState1XRTT_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_longCodeState1XRTT_r11_constr_12, &asn_PER_memb_longCodeState1XRTT_r11_constr_12,  memb_longCodeState1XRTT_r11_constraint_9 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_ParametersCDMA2000_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ParametersCDMA2000_r11, searchWindowSize_r11),
		...
		0,
		{ &asn_OER_memb_searchWindowSize_r11_constr_5, &asn_PER_memb_searchWindowSize_r11_constr_5,  memb_searchWindowSize_r11_constraint_1 },
		0, 0, /* No default value */
