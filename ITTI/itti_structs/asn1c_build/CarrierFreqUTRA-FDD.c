...
static asn_oer_constraints_t asn_OER_memb_p_MaxUTRA_constr_7 CC_NOTUSED = {
	{ 1, 0 }	/* (-50..33) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_q_QualMin_constr_8 CC_NOTUSED = {
	{ 1, 0 }	/* (-24..0) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CarrierFreqUTRA_FDD_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, q_RxLevMin),
		...
		0,
		{ &asn_OER_memb_q_RxLevMin_constr_6, &asn_PER_memb_q_RxLevMin_constr_6,  memb_q_RxLevMin_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMin"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, p_MaxUTRA),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p_MaxUTRA_constr_7, &asn_PER_memb_p_MaxUTRA_constr_7,  memb_p_MaxUTRA_constraint_1 },
		0, 0, /* No default value */
		"p-MaxUTRA"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqUTRA_FDD, q_QualMin),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_q_QualMin_constr_8, &asn_PER_memb_q_QualMin_constr_8,  memb_q_QualMin_constraint_1 },
		0, 0, /* No default value */
		"q-QualMin"
		},
