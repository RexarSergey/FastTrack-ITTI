...
static asn_oer_constraints_t asn_OER_type_operationModeInfo_r13_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_systemFrameNumber_MSB_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	4	/* (SIZE(4..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_hyperSFN_LSB_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_schedulingInfoSIB1_r13_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_systemInfoValueTag_r13_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_operationModeInfo_r13_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_operationModeInfo_r13_constr_7, &asn_PER_type_operationModeInfo_r13_constr_7, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_MasterInformationBlock_NB_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB, systemFrameNumber_MSB_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_systemFrameNumber_MSB_r13_constr_2, &asn_PER_memb_systemFrameNumber_MSB_r13_constr_2,  memb_systemFrameNumber_MSB_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB, hyperSFN_LSB_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_hyperSFN_LSB_r13_constr_3, &asn_PER_memb_hyperSFN_LSB_r13_constr_3,  memb_hyperSFN_LSB_r13_constraint_1 },
		0, 0, /* No default value */
		"hyperSFN-LSB-r13"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB, schedulingInfoSIB1_r13),
		...
		0,
		{ &asn_OER_memb_schedulingInfoSIB1_r13_constr_4, &asn_PER_memb_schedulingInfoSIB1_r13_constr_4,  memb_schedulingInfoSIB1_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_NB, systemInfoValueTag_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_systemInfoValueTag_r13_constr_5, &asn_PER_memb_systemInfoValueTag_r13_constr_5,  memb_systemInfoValueTag_r13_constraint_1 },
		0, 0, /* No default value */
