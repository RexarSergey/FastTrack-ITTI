...
static asn_oer_constraints_t asn_OER_memb_nrs_Power_r13_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-60..50) */,
	-1};
...
asn_TYPE_member_t asn_MBR_NPDSCH_ConfigCommon_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NPDSCH_ConfigCommon_NB_r13, nrs_Power_r13),
		...
		0,
		{ &asn_OER_memb_nrs_Power_r13_constr_2, &asn_PER_memb_nrs_Power_r13_constr_2,  memb_nrs_Power_r13_constraint_1 },
