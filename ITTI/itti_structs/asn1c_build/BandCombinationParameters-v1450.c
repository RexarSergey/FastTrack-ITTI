...
static asn_oer_constraints_t asn_OER_type_bandParameterList_v1450_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
static asn_oer_constraints_t asn_OER_memb_bandParameterList_v1450_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
asn_TYPE_descriptor_t asn_DEF_bandParameterList_v1450_2 = {
	...
	{ &asn_OER_type_bandParameterList_v1450_constr_2, &asn_PER_type_bandParameterList_v1450_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_BandCombinationParameters_v1450_1[] = {
	{ ATF_POINTER, 1, offsetof(struct BandCombinationParameters_v1450, bandParameterList_v1450),
		...
		0,
		{ &asn_OER_memb_bandParameterList_v1450_constr_2, &asn_PER_memb_bandParameterList_v1450_constr_2,  memb_bandParameterList_v1450_constraint_1 },
		0, 0, /* No default value */
		"bandParameterList-v1450"
		},
};
