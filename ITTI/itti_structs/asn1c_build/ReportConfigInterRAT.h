...
/* extern asn_TYPE_descriptor_t asn_DEF_si_RequestForHO_r9_43;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_reportQuantityUTRA_FDD_r10_45;	// (Use -fall-defs-global to expose) */
