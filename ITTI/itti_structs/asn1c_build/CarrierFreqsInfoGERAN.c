...
static asn_oer_constraints_t asn_OER_memb_ncc_Permitted_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_q_RxLevMin_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..45) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p_MaxGERAN_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..39) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_commonInfo_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, ncc_Permitted),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ncc_Permitted_constr_5, &asn_PER_memb_ncc_Permitted_constr_5,  memb_ncc_Permitted_constraint_3 },
		0, 0, /* No default value */
		"ncc-Permitted"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, q_RxLevMin),
		...
		0,
		{ &asn_OER_memb_q_RxLevMin_constr_6, &asn_PER_memb_q_RxLevMin_constr_6,  memb_q_RxLevMin_constraint_3 },
		0, 0, /* No default value */
		"q-RxLevMin"
		},
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqsInfoGERAN__commonInfo, p_MaxGERAN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p_MaxGERAN_constr_7, &asn_PER_memb_p_MaxGERAN_constr_7,  memb_p_MaxGERAN_constraint_3 },
		0, 0, /* No default value */
		"p-MaxGERAN"
		},
