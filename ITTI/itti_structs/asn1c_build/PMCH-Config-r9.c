...
static asn_oer_constraints_t asn_OER_type_mch_SchedulingPeriod_r9_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sf_AllocEnd_r9_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1535) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dataMCS_r9_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..28) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_r9_4 = {
	...
	{ &asn_OER_type_mch_SchedulingPeriod_r9_constr_4, &asn_PER_type_mch_SchedulingPeriod_r9_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PMCH_Config_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PMCH_Config_r9, sf_AllocEnd_r9),
		...
		0,
		{ &asn_OER_memb_sf_AllocEnd_r9_constr_2, &asn_PER_memb_sf_AllocEnd_r9_constr_2,  memb_sf_AllocEnd_r9_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PMCH_Config_r9, dataMCS_r9),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dataMCS_r9_constr_3, &asn_PER_memb_dataMCS_r9_constr_3,  memb_dataMCS_r9_constraint_1 },
		0, 0, /* No default value */
		"dataMCS-r9"
		},
