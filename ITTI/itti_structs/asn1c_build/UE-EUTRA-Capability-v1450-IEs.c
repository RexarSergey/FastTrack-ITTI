...
static asn_oer_constraints_t asn_OER_memb_ue_CategoryDL_v1450_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (20..20) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v1450_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct UE_EUTRA_Capability_v1450_IEs, ue_CategoryDL_v1450),
		...
		0,
		{ &asn_OER_memb_ue_CategoryDL_v1450_constr_5, &asn_PER_memb_ue_CategoryDL_v1450_constr_5,  memb_ue_CategoryDL_v1450_constraint_1 },
		0, 0, /* No default value */
		"ue-CategoryDL-v1450"
		},
