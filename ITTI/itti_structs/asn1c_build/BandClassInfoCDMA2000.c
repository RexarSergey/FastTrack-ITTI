...
static asn_oer_constraints_t asn_OER_memb_threshX_High_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_threshX_Low_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
asn_TYPE_member_t asn_MBR_BandClassInfoCDMA2000_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BandClassInfoCDMA2000, threshX_High),
		...
		0,
		{ &asn_OER_memb_threshX_High_constr_4, &asn_PER_memb_threshX_High_constr_4,  memb_threshX_High_constraint_1 },
		0, 0, /* No default value */
		"threshX-High"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct BandClassInfoCDMA2000, threshX_Low),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_threshX_Low_constr_5, &asn_PER_memb_threshX_Low_constr_5,  memb_threshX_Low_constraint_1 },
		0, 0, /* No default value */
		"threshX-Low"
		},
};
