...
static asn_oer_constraints_t asn_OER_memb_cif_InSchedulingCell_r14_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CrossCarrierSchedulingConfigLAA_UL_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfigLAA_UL_r14, cif_InSchedulingCell_r14),
		...
		0,
		{ &asn_OER_memb_cif_InSchedulingCell_r14_constr_3, &asn_PER_memb_cif_InSchedulingCell_r14_constr_3,  memb_cif_InSchedulingCell_r14_constraint_1 },
		0, 0, /* No default value */
