...
static asn_oer_constraints_t asn_OER_memb_traceId_r10_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
asn_TYPE_member_t asn_MBR_TraceReference_r10_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TraceReference_r10, traceId_r10),
		...
		0,
		{ &asn_OER_memb_traceId_r10_constr_3, &asn_PER_memb_traceId_r10_constr_3,  memb_traceId_r10_constraint_1 },
		0, 0, /* No default value */
		"traceId-r10"
		},
};
