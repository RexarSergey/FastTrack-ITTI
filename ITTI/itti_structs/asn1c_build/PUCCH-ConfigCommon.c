...
static asn_oer_constraints_t asn_OER_type_deltaPUCCH_Shift_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_nRB_CQI_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..98) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_nCS_AN_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_n1PUCCH_AN_constr_8 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_deltaPUCCH_Shift_2 = {
	...
	{ &asn_OER_type_deltaPUCCH_Shift_constr_2, &asn_PER_type_deltaPUCCH_Shift_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUCCH_ConfigCommon_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, nRB_CQI),
		...
		0,
		{ &asn_OER_memb_nRB_CQI_constr_6, &asn_PER_memb_nRB_CQI_constr_6,  memb_nRB_CQI_constraint_1 },
		0, 0, /* No default value */
		"nRB-CQI"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, nCS_AN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_nCS_AN_constr_7, &asn_PER_memb_nCS_AN_constr_7,  memb_nCS_AN_constraint_1 },
		0, 0, /* No default value */
		"nCS-AN"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigCommon, n1PUCCH_AN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_n1PUCCH_AN_constr_8, &asn_PER_memb_n1PUCCH_AN_constr_8,  memb_n1PUCCH_AN_constraint_1 },
		0, 0, /* No default value */
		"n1PUCCH-AN"
		},
};
