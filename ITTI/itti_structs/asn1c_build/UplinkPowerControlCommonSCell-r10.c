...
static asn_oer_constraints_t asn_OER_memb_p0_NominalPUSCH_r10_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UplinkPowerControlCommonSCell_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommonSCell_r10, p0_NominalPUSCH_r10),
		...
		0,
		{ &asn_OER_memb_p0_NominalPUSCH_r10_constr_2, &asn_PER_memb_p0_NominalPUSCH_r10_constr_2,  memb_p0_NominalPUSCH_r10_constraint_1 },
