...
static asn_oer_constraints_t asn_OER_memb_networkColourCode_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
static asn_oer_constraints_t asn_OER_memb_baseStationColourCode_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
asn_TYPE_member_t asn_MBR_PhysCellIdGERAN_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PhysCellIdGERAN, networkColourCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_networkColourCode_constr_2, &asn_PER_memb_networkColourCode_constr_2,  memb_networkColourCode_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PhysCellIdGERAN, baseStationColourCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_baseStationColourCode_constr_3, &asn_PER_memb_baseStationColourCode_constr_3,  memb_baseStationColourCode_constraint_1 },
		0, 0, /* No default value */
