...
static asn_oer_constraints_t asn_OER_type_drb_Type_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_eps_BearerIdentity_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_drb_Type_r12_4 = {
	...
	{ &asn_OER_type_drb_Type_r12_constr_4, &asn_PER_type_drb_Type_r12_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_DRB_InfoSCG_r12_1[] = {
	{ ATF_POINTER, 1, offsetof(struct DRB_InfoSCG_r12, eps_BearerIdentity_r12),
		...
		0,
		{ &asn_OER_memb_eps_BearerIdentity_r12_constr_2, &asn_PER_memb_eps_BearerIdentity_r12_constr_2,  memb_eps_BearerIdentity_r12_constraint_1 },
