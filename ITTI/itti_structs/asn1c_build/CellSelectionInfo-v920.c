...
static asn_oer_constraints_t asn_OER_memb_q_QualMinOffset_r9_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CellSelectionInfo_v920_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellSelectionInfo_v920, q_QualMinOffset_r9),
		...
		0,
		{ &asn_OER_memb_q_QualMinOffset_r9_constr_3, &asn_PER_memb_q_QualMinOffset_r9_constr_3,  memb_q_QualMinOffset_r9_constraint_1 },
		0, 0, /* No default value */
		"q-QualMinOffset-r9"
		},
};
