...
static asn_oer_constraints_t asn_OER_memb_mch_Index_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_DataBLER_MCH_Result_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DataBLER_MCH_Result_r12, mch_Index_r12),
		...
		0,
		{ &asn_OER_memb_mch_Index_r12_constr_2, &asn_PER_memb_mch_Index_r12_constr_2,  memb_mch_Index_r12_constraint_1 },
