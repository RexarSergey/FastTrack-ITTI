...
static asn_oer_constraints_t asn_OER_memb_discSF_Index_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..200) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_discPRB_Index_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..50) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SL_TF_IndexPair_r12_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SL_TF_IndexPair_r12, discSF_Index_r12),
		...
		0,
		{ &asn_OER_memb_discSF_Index_r12_constr_2, &asn_PER_memb_discSF_Index_r12_constr_2,  memb_discSF_Index_r12_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct SL_TF_IndexPair_r12, discPRB_Index_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_discPRB_Index_r12_constr_3, &asn_PER_memb_discPRB_Index_r12_constr_3,  memb_discPRB_Index_r12_constraint_1 },
		0, 0, /* No default value */
		"discPRB-Index-r12"
		},
};
