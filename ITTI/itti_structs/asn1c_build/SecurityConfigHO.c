...
static asn_oer_constraints_t asn_OER_memb_nas_SecurityParamToEUTRA_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_type_handoverType_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_interRAT_7[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SecurityConfigHO__handoverType__interRAT, nas_SecurityParamToEUTRA),
		...
		0,
		{ &asn_OER_memb_nas_SecurityParamToEUTRA_constr_9, &asn_PER_memb_nas_SecurityParamToEUTRA_constr_9,  memb_nas_SecurityParamToEUTRA_constraint_7 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_handoverType_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_handoverType_constr_2, &asn_PER_type_handoverType_constr_2, CHOICE_constraint },
