...
static asn_oer_constraints_t asn_OER_memb_ue_Category_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..5) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndicators_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_EUTRA_Capability, ue_Category),
		...
		0,
		{ &asn_OER_memb_ue_Category_constr_3, &asn_PER_memb_ue_Category_constr_3,  memb_ue_Category_constraint_1 },
		0, 0, /* No default value */
		"ue-Category"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct UE_EUTRA_Capability, featureGroupIndicators),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndicators_constr_8, &asn_PER_memb_featureGroupIndicators_constr_8,  memb_featureGroupIndicators_constraint_1 },
		0, 0, /* No default value */
