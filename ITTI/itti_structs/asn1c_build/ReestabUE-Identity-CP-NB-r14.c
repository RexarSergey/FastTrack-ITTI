...
static asn_oer_constraints_t asn_OER_memb_ul_NAS_MAC_r14_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_ul_NAS_Count_r14_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	5	/* (SIZE(5..5)) */};
...
asn_TYPE_member_t asn_MBR_ReestabUE_Identity_CP_NB_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReestabUE_Identity_CP_NB_r14, ul_NAS_MAC_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ul_NAS_MAC_r14_constr_3, &asn_PER_memb_ul_NAS_MAC_r14_constr_3,  memb_ul_NAS_MAC_r14_constraint_1 },
		0, 0, /* No default value */
		"ul-NAS-MAC-r14"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ReestabUE_Identity_CP_NB_r14, ul_NAS_Count_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ul_NAS_Count_r14_constr_4, &asn_PER_memb_ul_NAS_Count_r14_constr_4,  memb_ul_NAS_Count_r14_constraint_1 },
		0, 0, /* No default value */
		"ul-NAS-Count-r14"
		},
};
