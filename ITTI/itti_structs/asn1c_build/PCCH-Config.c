 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_defaultPagingCycle_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_nB_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_defaultPagingCycle_2 = {
	...
	{ &asn_OER_type_defaultPagingCycle_constr_2, &asn_PER_type_defaultPagingCycle_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nB_7 = {
	...
	{ &asn_OER_type_nB_constr_7, &asn_PER_type_nB_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
