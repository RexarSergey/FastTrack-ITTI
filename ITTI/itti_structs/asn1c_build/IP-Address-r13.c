...
static asn_oer_constraints_t asn_OER_memb_ipv4_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_oer_constraints_t asn_OER_memb_ipv6_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	128	/* (SIZE(128..128)) */};
...
static asn_oer_constraints_t asn_OER_type_IP_Address_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_IP_Address_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct IP_Address_r13, choice.ipv4_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ipv4_r13_constr_2, &asn_PER_memb_ipv4_r13_constr_2,  memb_ipv4_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IP_Address_r13, choice.ipv6_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ipv6_r13_constr_3, &asn_PER_memb_ipv6_r13_constr_3,  memb_ipv6_r13_constraint_1 },
		0, 0, /* No default value */
		"ipv6-r13"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_IP_Address_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_IP_Address_r13_constr_1, &asn_PER_type_IP_Address_r13_constr_1, CHOICE_constraint },
