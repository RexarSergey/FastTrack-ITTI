...
static asn_oer_constraints_t asn_OER_type_dedicatedInfoNASList_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..11)) */};
...
static asn_oer_constraints_t asn_OER_memb_dedicatedInfoNASList_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..11)) */};
...
asn_TYPE_descriptor_t asn_DEF_dedicatedInfoNASList_4 = {
	...
	{ &asn_OER_type_dedicatedInfoNASList_constr_4, &asn_PER_type_dedicatedInfoNASList_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_RRCConnectionReconfiguration_r8_IEs_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct RRCConnectionReconfiguration_r8_IEs, dedicatedInfoNASList),
		...
		0,
		{ &asn_OER_memb_dedicatedInfoNASList_constr_4, &asn_PER_memb_dedicatedInfoNASList_constr_4,  memb_dedicatedInfoNASList_constraint_1 },
		0, 0, /* No default value */
		"dedicatedInfoNASList"
		},
