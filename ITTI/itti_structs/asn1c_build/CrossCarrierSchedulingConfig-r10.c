...
static asn_oer_constraints_t asn_OER_memb_pdsch_Start_r10_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_schedulingCellInfo_r10_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_other_r10_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig_r10__schedulingCellInfo_r10__other_r10, pdsch_Start_r10),
		...
		0,
		{ &asn_OER_memb_pdsch_Start_r10_constr_7, &asn_PER_memb_pdsch_Start_r10_constr_7,  memb_pdsch_Start_r10_constraint_5 },
		0, 0, /* No default value */
		"pdsch-Start-r10"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_schedulingCellInfo_r10_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_schedulingCellInfo_r10_constr_2, &asn_PER_type_schedulingCellInfo_r10_constr_2, CHOICE_constraint },
