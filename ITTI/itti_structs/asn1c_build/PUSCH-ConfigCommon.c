...
static asn_oer_constraints_t asn_OER_type_hoppingMode_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_n_SB_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_pusch_HoppingOffset_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..98) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_hoppingMode_4 = {
	...
	{ &asn_OER_type_hoppingMode_constr_4, &asn_PER_type_hoppingMode_constr_4, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_pusch_ConfigBasic_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigCommon__pusch_ConfigBasic, n_SB),
		...
		0,
		{ &asn_OER_memb_n_SB_constr_3, &asn_PER_memb_n_SB_constr_3,  memb_n_SB_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigCommon__pusch_ConfigBasic, pusch_HoppingOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_pusch_HoppingOffset_constr_7, &asn_PER_memb_pusch_HoppingOffset_constr_7,  memb_pusch_HoppingOffset_constraint_2 },
		0, 0, /* No default value */
		"pusch-HoppingOffset"
		},
