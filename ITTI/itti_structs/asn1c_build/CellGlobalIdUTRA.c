...
static asn_oer_constraints_t asn_OER_memb_cellIdentity_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	28	/* (SIZE(28..28)) */};
...
asn_TYPE_member_t asn_MBR_CellGlobalIdUTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdUTRA, cellIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_cellIdentity_constr_3, &asn_PER_memb_cellIdentity_constr_3,  memb_cellIdentity_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity"
		},
};
