...
static asn_oer_constraints_t asn_OER_type_numSubbands_r12_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_hoppingParameter_r12_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..504) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_rb_Offset_r12_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..110) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_numSubbands_r12_3 = {
	...
	{ &asn_OER_type_numSubbands_r12_constr_3, &asn_PER_type_numSubbands_r12_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SL_HoppingConfigComm_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SL_HoppingConfigComm_r12, hoppingParameter_r12),
		...
		0,
		{ &asn_OER_memb_hoppingParameter_r12_constr_2, &asn_PER_memb_hoppingParameter_r12_constr_2,  memb_hoppingParameter_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_HoppingConfigComm_r12, rb_Offset_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_rb_Offset_r12_constr_7, &asn_PER_memb_rb_Offset_r12_constr_7,  memb_rb_Offset_r12_constraint_1 },
		0, 0, /* No default value */
		"rb-Offset-r12"
		},
};
