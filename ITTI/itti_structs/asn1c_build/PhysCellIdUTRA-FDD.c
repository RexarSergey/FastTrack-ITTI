 ...
 */
static asn_oer_constraints_t asn_OER_type_PhysCellIdUTRA_FDD_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..511) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_PhysCellIdUTRA_FDD = {
	...
	sizeof(asn_DEF_PhysCellIdUTRA_FDD_tags_1)
		/sizeof(asn_DEF_PhysCellIdUTRA_FDD_tags_1[0]), /* 1 */
	{ &asn_OER_type_PhysCellIdUTRA_FDD_constr_1, &asn_PER_type_PhysCellIdUTRA_FDD_constr_1, PhysCellIdUTRA_FDD_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
