...
static asn_oer_constraints_t asn_OER_type_p_a_r13_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_g_RNTI_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_sc_mtch_neighbourCell_r13_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_p_a_r13_7 = {
	...
	{ &asn_OER_type_p_a_r13_constr_7, &asn_PER_type_p_a_r13_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SC_MTCH_Info_r13_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SC_MTCH_Info_r13, g_RNTI_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_g_RNTI_r13_constr_3, &asn_PER_memb_g_RNTI_r13_constr_3,  memb_g_RNTI_r13_constraint_1 },
		0, 0, /* No default value */
		"g-RNTI-r13"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct SC_MTCH_Info_r13, sc_mtch_neighbourCell_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sc_mtch_neighbourCell_r13_constr_5, &asn_PER_memb_sc_mtch_neighbourCell_r13_constr_5,  memb_sc_mtch_neighbourCell_r13_constraint_1 },
		0, 0, /* No default value */
