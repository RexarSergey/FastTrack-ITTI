...
static asn_oer_constraints_t asn_OER_memb_plmn_Index_r9_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_plmn_Id_r9_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_serviceId_r9_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	3	/* (SIZE(3..3)) */};
...
static asn_TYPE_member_t asn_MBR_plmn_Id_r9_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TMGI_r9__plmn_Id_r9, choice.plmn_Index_r9),
		...
		0,
		{ &asn_OER_memb_plmn_Index_r9_constr_3, &asn_PER_memb_plmn_Index_r9_constr_3,  memb_plmn_Index_r9_constraint_2 },
...
asn_TYPE_descriptor_t asn_DEF_plmn_Id_r9_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_plmn_Id_r9_constr_2, &asn_PER_type_plmn_Id_r9_constr_2, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_TMGI_r9_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TMGI_r9, serviceId_r9),
		...
		0,
		{ &asn_OER_memb_serviceId_r9_constr_5, &asn_PER_memb_serviceId_r9_constr_5,  memb_serviceId_r9_constraint_1 },
		0, 0, /* No default value */
		"serviceId-r9"
		},
};
