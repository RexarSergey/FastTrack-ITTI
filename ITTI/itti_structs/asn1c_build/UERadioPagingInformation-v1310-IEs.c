...
static asn_oer_constraints_t asn_OER_type_supportedBandListEUTRAForPaging_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
static asn_oer_constraints_t asn_OER_memb_supportedBandListEUTRAForPaging_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
asn_TYPE_descriptor_t asn_DEF_supportedBandListEUTRAForPaging_r13_2 = {
	...
	{ &asn_OER_type_supportedBandListEUTRAForPaging_r13_constr_2, &asn_PER_type_supportedBandListEUTRAForPaging_r13_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_UERadioPagingInformation_v1310_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UERadioPagingInformation_v1310_IEs, supportedBandListEUTRAForPaging_r13),
		...
		0,
		{ &asn_OER_memb_supportedBandListEUTRAForPaging_r13_constr_2, &asn_PER_memb_supportedBandListEUTRAForPaging_r13_constr_2,  memb_supportedBandListEUTRAForPaging_r13_constraint_1 },
		0, 0, /* No default value */
		"supportedBandListEUTRAForPaging-r13"
		},
