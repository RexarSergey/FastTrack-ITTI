...
static asn_oer_constraints_t asn_OER_type_neighCellList_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_neighCellList_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
asn_TYPE_descriptor_t asn_DEF_neighCellList_r11_3 = {
	...
	{ &asn_OER_type_neighCellList_r11_constr_3, &asn_PER_type_neighCellList_r11_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_CellReselectionParametersCDMA2000_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellReselectionParametersCDMA2000_r11, neighCellList_r11),
		...
		0,
		{ &asn_OER_memb_neighCellList_r11_constr_3, &asn_PER_memb_neighCellList_r11_constr_3,  memb_neighCellList_r11_constraint_1 },
		0, 0, /* No default value */
		"neighCellList-r11"
		},
