...
static asn_oer_constraints_t asn_OER_type_PLMN_IdentityList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..6)) */};
...
asn_TYPE_descriptor_t asn_DEF_PLMN_IdentityList = {
	...
	sizeof(asn_DEF_PLMN_IdentityList_tags_1)
		/sizeof(asn_DEF_PLMN_IdentityList_tags_1[0]), /* 1 */
	{ &asn_OER_type_PLMN_IdentityList_constr_1, &asn_PER_type_PLMN_IdentityList_constr_1, SEQUENCE_OF_constraint },
