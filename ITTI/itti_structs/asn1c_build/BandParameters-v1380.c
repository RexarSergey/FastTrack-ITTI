...
static asn_oer_constraints_t asn_OER_memb_txAntennaSwitchDL_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..32) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_txAntennaSwitchUL_r13_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..32) */,
	-1};
...
asn_TYPE_member_t asn_MBR_BandParameters_v1380_1[] = {
	{ ATF_POINTER, 2, offsetof(struct BandParameters_v1380, txAntennaSwitchDL_r13),
		...
		0,
		{ &asn_OER_memb_txAntennaSwitchDL_r13_constr_2, &asn_PER_memb_txAntennaSwitchDL_r13_constr_2,  memb_txAntennaSwitchDL_r13_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct BandParameters_v1380, txAntennaSwitchUL_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_txAntennaSwitchUL_r13_constr_3, &asn_PER_memb_txAntennaSwitchUL_r13_constr_3,  memb_txAntennaSwitchUL_r13_constraint_1 },
		0, 0, /* No default value */
