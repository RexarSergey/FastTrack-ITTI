...
static int
memb_carrierFreqListUTRA_FDD_v1250_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static int
memb_carrierFreqListUTRA_TDD_v1250_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_carrierFreqListUTRA_FDD_v1250_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
static asn_per_constraints_t asn_PER_type_carrierFreqListUTRA_FDD_v1250_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_carrierFreqListUTRA_TDD_v1250_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
static asn_per_constraints_t asn_PER_type_carrierFreqListUTRA_TDD_v1250_constr_10 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_lateNonCriticalExtension_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_memb_carrierFreqListUTRA_FDD_v1250_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
static asn_per_constraints_t asn_PER_memb_carrierFreqListUTRA_FDD_v1250_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_carrierFreqListUTRA_TDD_v1250_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
static asn_per_constraints_t asn_PER_memb_carrierFreqListUTRA_TDD_v1250_constr_10 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_carrierFreqListUTRA_FDD_v1250_8 = {
	...
	{ &asn_OER_type_carrierFreqListUTRA_FDD_v1250_constr_8, &asn_PER_type_carrierFreqListUTRA_FDD_v1250_constr_8, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_carrierFreqListUTRA_TDD_v1250_10 = {
	...
	{ &asn_OER_type_carrierFreqListUTRA_TDD_v1250_constr_10, &asn_PER_type_carrierFreqListUTRA_TDD_v1250_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType6_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType6, lateNonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_lateNonCriticalExtension_constr_7, &asn_PER_memb_lateNonCriticalExtension_constr_7,  memb_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType6, carrierFreqListUTRA_FDD_v1250),
		...
		0,
		{ &asn_OER_memb_carrierFreqListUTRA_FDD_v1250_constr_8, &asn_PER_memb_carrierFreqListUTRA_FDD_v1250_constr_8,  memb_carrierFreqListUTRA_FDD_v1250_constraint_1 },
		0, 0, /* No default value */
		"carrierFreqListUTRA-FDD-v1250"
		},
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType6, carrierFreqListUTRA_TDD_v1250),
		...
		0,
		{ &asn_OER_memb_carrierFreqListUTRA_TDD_v1250_constr_10, &asn_PER_memb_carrierFreqListUTRA_TDD_v1250_constr_10,  memb_carrierFreqListUTRA_TDD_v1250_constraint_1 },
		0, 0, /* No default value */
		"carrierFreqListUTRA-TDD-v1250"
		},
