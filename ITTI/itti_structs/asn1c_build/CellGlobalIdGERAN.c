...
static asn_oer_constraints_t asn_OER_memb_locationAreaCode_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_TYPE_member_t asn_MBR_CellGlobalIdGERAN_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN, locationAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_locationAreaCode_constr_3, &asn_PER_memb_locationAreaCode_constr_3,  memb_locationAreaCode_constraint_1 },
		0, 0, /* No default value */
		"locationAreaCode"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdGERAN, cellIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_cellIdentity_constr_4, &asn_PER_memb_cellIdentity_constr_4,  memb_cellIdentity_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity"
		},
};
