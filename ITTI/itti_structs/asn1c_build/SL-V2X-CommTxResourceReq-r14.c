...
static asn_oer_constraints_t asn_OER_memb_carrierFreqCommTx_r14_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SL_V2X_CommTxResourceReq_r14_1[] = {
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_CommTxResourceReq_r14, carrierFreqCommTx_r14),
		...
		0,
		{ &asn_OER_memb_carrierFreqCommTx_r14_constr_2, &asn_PER_memb_carrierFreqCommTx_r14_constr_2,  memb_carrierFreqCommTx_r14_constraint_1 },
