...
static asn_oer_constraints_t asn_OER_memb_range_r9_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (2..512) */,
	-1};
...
asn_TYPE_member_t asn_MBR_PhysCellIdRangeUTRA_FDD_r9_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PhysCellIdRangeUTRA_FDD_r9, range_r9),
		...
		0,
		{ &asn_OER_memb_range_r9_constr_3, &asn_PER_memb_range_r9_constr_3,  memb_range_r9_constraint_1 },
		0, 0, /* No default value */
		"range-r9"
		},
};
