...
static asn_oer_constraints_t asn_OER_memb_syncConfigIndex_r12_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_rxParametersNCell_r12_10[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_CommResourcePool_r12__rxParametersNCell_r12, syncConfigIndex_r12),
		...
		0,
		{ &asn_OER_memb_syncConfigIndex_r12_constr_12, &asn_PER_memb_syncConfigIndex_r12_constr_12,  memb_syncConfigIndex_r12_constraint_10 },
		0, 0, /* No default value */
		"syncConfigIndex-r12"
		},
};
...
asn_TYPE_member_t asn_MBR_SL_CommResourcePool_r12_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_CommResourcePool_r12, priorityList_r13),
...
static const asn_TYPE_tag2member_t asn_MAP_SL_CommResourcePool_r12_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* priorityList-r13 */
};
