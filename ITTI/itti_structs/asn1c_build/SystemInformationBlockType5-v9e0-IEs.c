...
static asn_oer_constraints_t asn_OER_type_interFreqCarrierFreqList_v9e0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_interFreqCarrierFreqList_v9e0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_interFreqCarrierFreqList_v9e0_2 = {
	...
	{ &asn_OER_type_interFreqCarrierFreqList_v9e0_constr_2, &asn_PER_type_interFreqCarrierFreqList_v9e0_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType5_v9e0_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType5_v9e0_IEs, interFreqCarrierFreqList_v9e0),
		...
		0,
		{ &asn_OER_memb_interFreqCarrierFreqList_v9e0_constr_2, &asn_PER_memb_interFreqCarrierFreqList_v9e0_constr_2,  memb_interFreqCarrierFreqList_v9e0_constraint_1 },
		0, 0, /* No default value */
		"interFreqCarrierFreqList-v9e0"
		},
