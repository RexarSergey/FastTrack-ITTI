...
static asn_oer_constraints_t asn_OER_type_csi_RS_NZP_mode_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_activatedResources_r14_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..4) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_csi_RS_NZP_mode_r14_2 = {
	...
	{ &asn_OER_type_csi_RS_NZP_mode_r14_constr_2, &asn_PER_type_csi_RS_NZP_mode_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigNZP_Activation_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ConfigNZP_Activation_r14, activatedResources_r14),
		...
		0,
		{ &asn_OER_memb_activatedResources_r14_constr_5, &asn_PER_memb_activatedResources_r14_constr_5,  memb_activatedResources_r14_constraint_1 },
		0, 0, /* No default value */
