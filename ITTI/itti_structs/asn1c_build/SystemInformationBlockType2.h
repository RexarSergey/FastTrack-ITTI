...
typedef enum SystemInformationBlockType2__voiceServiceCauseIndication_r12 {
	SystemInformationBlockType2__voiceServiceCauseIndication_r12_true	= 0
} e_SystemInformationBlockType2__voiceServiceCauseIndication_r12;
typedef enum SystemInformationBlockType2__useFullResumeID_r13 {
	SystemInformationBlockType2__useFullResumeID_r13_true	= 0
} e_SystemInformationBlockType2__useFullResumeID_r13;
typedef enum SystemInformationBlockType2__unicastFreqHoppingInd_r13 {
	SystemInformationBlockType2__unicastFreqHoppingInd_r13_true	= 0
} e_SystemInformationBlockType2__unicastFreqHoppingInd_r13;
typedef enum SystemInformationBlockType2__videoServiceCauseIndication_r14 {
	SystemInformationBlockType2__videoServiceCauseIndication_r14_true	= 0
} e_SystemInformationBlockType2__videoServiceCauseIndication_r14;
...
/* extern asn_TYPE_descriptor_t asn_DEF_voiceServiceCauseIndication_r12_32;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_useFullResumeID_r13_39;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_unicastFreqHoppingInd_r13_41;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_videoServiceCauseIndication_r14_44;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_1[24];
