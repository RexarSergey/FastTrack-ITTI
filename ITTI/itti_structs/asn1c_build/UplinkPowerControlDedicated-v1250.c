...
static asn_oer_constraints_t asn_OER_memb_tpc_SubframeSet_r12_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_p0_NominalPUSCH_SubframeSet2_r12_constr_6 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p0_UE_PUSCH_SubframeSet2_r12_constr_8 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_set2PowerControlParameter_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlDedicated_v1250__set2PowerControlParameter__setup, tpc_SubframeSet_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_tpc_SubframeSet_r12_constr_5, &asn_PER_memb_tpc_SubframeSet_r12_constr_5,  memb_tpc_SubframeSet_r12_constraint_4 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlDedicated_v1250__set2PowerControlParameter__setup, p0_NominalPUSCH_SubframeSet2_r12),
		...
		0,
		{ &asn_OER_memb_p0_NominalPUSCH_SubframeSet2_r12_constr_6, &asn_PER_memb_p0_NominalPUSCH_SubframeSet2_r12_constr_6,  memb_p0_NominalPUSCH_SubframeSet2_r12_constraint_4 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlDedicated_v1250__set2PowerControlParameter__setup, p0_UE_PUSCH_SubframeSet2_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p0_UE_PUSCH_SubframeSet2_r12_constr_8, &asn_PER_memb_p0_UE_PUSCH_SubframeSet2_r12_constr_8,  memb_p0_UE_PUSCH_SubframeSet2_r12_constraint_4 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_set2PowerControlParameter_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_set2PowerControlParameter_constr_2, &asn_PER_type_set2PowerControlParameter_constr_2, CHOICE_constraint },
