...
asn_TYPE_member_t asn_MBR_ConnEstFailReport_r11_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct ConnEstFailReport_r11, measResultListEUTRA_v1130),
	...
	{ ATF_POINTER, 4, offsetof(struct ConnEstFailReport_r11, measResultFailedCell_v1250),
	...
	{ ATF_POINTER, 3, offsetof(struct ConnEstFailReport_r11, failedCellRSRQ_Type_r12),
	...
	{ ATF_POINTER, 2, offsetof(struct ConnEstFailReport_r11, measResultListEUTRA_v1250),
	...
	{ ATF_POINTER, 1, offsetof(struct ConnEstFailReport_r11, measResultFailedCell_v1360),
...
static const int asn_MAP_ConnEstFailReport_r11_oms_1[] = { 1, 3, 8, 9, 10, 11, 12 };
...
static const asn_TYPE_tag2member_t asn_MAP_ConnEstFailReport_r11_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* measResultFailedCell-v1250 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* failedCellRSRQ-Type-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 11, 0, 0 }, /* measResultListEUTRA-v1250 */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 12, 0, 0 } /* measResultFailedCell-v1360 */
};
