...
typedef struct MeasResultServFreq_r10 {
	...
	struct MeasResultServFreq_r10__measResultSCell_v1310 {
		RS_SINR_Range_r13_t	 rs_sinr_Result_r13;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *measResultSCell_v1310;
	struct MeasResultServFreq_r10__measResultBestNeighCell_v1310 {
		RS_SINR_Range_r13_t	 rs_sinr_Result_r13;
...
extern asn_TYPE_member_t asn_MBR_MeasResultServFreq_r10_1[7];
