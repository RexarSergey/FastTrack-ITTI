...
static asn_oer_constraints_t asn_OER_memb_offsetDFN_r14_constr_11 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1000) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SL_V2X_InterFreqUE_Config_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_InterFreqUE_Config_r14, offsetDFN_r14),
		...
		0,
		{ &asn_OER_memb_offsetDFN_r14_constr_11, &asn_PER_memb_offsetDFN_r14_constr_11,  memb_offsetDFN_r14_constraint_1 },
		0, 0, /* No default value */
		"offsetDFN-r14"
		},
};
