...
static asn_oer_constraints_t asn_OER_type_c_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_a_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..200) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_b_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..10) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_c_r12_4 = {
	...
	{ &asn_OER_type_c_r12_constr_4, &asn_PER_type_c_r12_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SL_HoppingConfigDisc_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SL_HoppingConfigDisc_r12, a_r12),
		...
		0,
		{ &asn_OER_memb_a_r12_constr_2, &asn_PER_memb_a_r12_constr_2,  memb_a_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_HoppingConfigDisc_r12, b_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_b_r12_constr_3, &asn_PER_memb_b_r12_constr_3,  memb_b_r12_constraint_1 },
		0, 0, /* No default value */
		"b-r12"
		},
