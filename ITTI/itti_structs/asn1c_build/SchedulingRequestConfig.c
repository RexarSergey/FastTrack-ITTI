...
static asn_oer_constraints_t asn_OER_type_dsr_TransMax_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sr_PUCCH_ResourceIndex_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sr_ConfigIndex_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..157) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_SchedulingRequestConfig_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_dsr_TransMax_6 = {
	...
	{ &asn_OER_type_dsr_TransMax_constr_6, &asn_PER_type_dsr_TransMax_constr_6, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingRequestConfig__setup, sr_PUCCH_ResourceIndex),
		...
		0,
		{ &asn_OER_memb_sr_PUCCH_ResourceIndex_constr_4, &asn_PER_memb_sr_PUCCH_ResourceIndex_constr_4,  memb_sr_PUCCH_ResourceIndex_constraint_3 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SchedulingRequestConfig__setup, sr_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sr_ConfigIndex_constr_5, &asn_PER_memb_sr_ConfigIndex_constr_5,  memb_sr_ConfigIndex_constraint_3 },
		0, 0, /* No default value */
		"sr-ConfigIndex"
		},
...
asn_TYPE_descriptor_t asn_DEF_SchedulingRequestConfig = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_SchedulingRequestConfig_constr_1, &asn_PER_type_SchedulingRequestConfig_constr_1, CHOICE_constraint },
