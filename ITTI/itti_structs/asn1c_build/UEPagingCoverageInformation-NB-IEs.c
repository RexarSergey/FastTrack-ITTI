...
static asn_oer_constraints_t asn_OER_memb_npdcch_NumRepetitionPaging_r13_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (1..2048) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UEPagingCoverageInformation_NB_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UEPagingCoverageInformation_NB_IEs, npdcch_NumRepetitionPaging_r13),
		...
		0,
		{ &asn_OER_memb_npdcch_NumRepetitionPaging_r13_constr_2, &asn_PER_memb_npdcch_NumRepetitionPaging_r13_constr_2,  memb_npdcch_NumRepetitionPaging_r13_constraint_1 },
