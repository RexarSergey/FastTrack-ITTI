...
static asn_oer_constraints_t asn_OER_type_ab_Category_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_ab_BarringForExceptionData_r13_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ab_BarringBitmap_r13_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_ab_BarringForSpecialAC_r13_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	5	/* (SIZE(5..5)) */};
...
asn_TYPE_descriptor_t asn_DEF_ab_Category_r13_2 = {
	...
	{ &asn_OER_type_ab_Category_r13_constr_2, &asn_PER_type_ab_Category_r13_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ab_BarringForExceptionData_r13_7 = {
	...
	{ &asn_OER_type_ab_BarringForExceptionData_r13_constr_7, &asn_PER_type_ab_BarringForExceptionData_r13_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_AB_Config_NB_r13_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AB_Config_NB_r13, ab_BarringBitmap_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ab_BarringBitmap_r13_constr_6, &asn_PER_memb_ab_BarringBitmap_r13_constr_6,  memb_ab_BarringBitmap_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AB_Config_NB_r13, ab_BarringForSpecialAC_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ab_BarringForSpecialAC_r13_constr_9, &asn_PER_memb_ab_BarringForSpecialAC_r13_constr_9,  memb_ab_BarringForSpecialAC_r13_constraint_1 },
		0, 0, /* No default value */
