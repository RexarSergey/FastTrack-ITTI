...
static asn_oer_constraints_t asn_OER_memb_m_TMSI_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
asn_TYPE_member_t asn_MBR_S_TMSI_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct S_TMSI, m_TMSI),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_m_TMSI_constr_3, &asn_PER_memb_m_TMSI_constr_3,  memb_m_TMSI_constraint_1 },
		0, 0, /* No default value */
		"m-TMSI"
		},
};
