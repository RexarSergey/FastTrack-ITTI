...
static asn_oer_constraints_t asn_OER_memb_trigger1_r10_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_trigger2_r10_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_type_CQI_ReportAperiodic_r10_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_aperiodicCSI_Trigger_r10_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportAperiodic_r10__setup__aperiodicCSI_Trigger_r10, trigger1_r10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_trigger1_r10_constr_6, &asn_PER_memb_trigger1_r10_constr_6,  memb_trigger1_r10_constraint_5 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportAperiodic_r10__setup__aperiodicCSI_Trigger_r10, trigger2_r10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_trigger2_r10_constr_7, &asn_PER_memb_trigger2_r10_constr_7,  memb_trigger2_r10_constraint_5 },
		0, 0, /* No default value */
		"trigger2-r10"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportAperiodic_r10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_CQI_ReportAperiodic_r10_constr_1, &asn_PER_type_CQI_ReportAperiodic_r10_constr_1, CHOICE_constraint },
