...
typedef enum IDC_Config_r11__idc_Indication_UL_CA_r11 {
	IDC_Config_r11__idc_Indication_UL_CA_r11_setup	= 0
} e_IDC_Config_r11__idc_Indication_UL_CA_r11;
typedef enum IDC_Config_r11__idc_HardwareSharingIndication_r13 {
	IDC_Config_r11__idc_HardwareSharingIndication_r13_setup	= 0
} e_IDC_Config_r11__idc_HardwareSharingIndication_r13;
...
/* extern asn_TYPE_descriptor_t asn_DEF_idc_Indication_UL_CA_r11_24;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_idc_HardwareSharingIndication_r13_26;	// (Use -fall-defs-global to expose) */
