...
static asn_oer_constraints_t asn_OER_type_q_Hyst_r13_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_q_RxLevMinOffset_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_q_Hyst_r13_4 = {
	...
	{ &asn_OER_type_q_Hyst_r13_constr_4, &asn_PER_type_q_Hyst_r13_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CellSelectionInfoNFreq_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellSelectionInfoNFreq_r13, q_RxLevMinOffset),
		...
		0,
		{ &asn_OER_memb_q_RxLevMinOffset_constr_3, &asn_PER_memb_q_RxLevMinOffset_constr_3,  memb_q_RxLevMinOffset_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMinOffset"
		},
