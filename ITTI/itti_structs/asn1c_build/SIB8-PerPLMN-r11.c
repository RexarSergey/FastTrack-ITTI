...
static asn_oer_constraints_t asn_OER_type_parametersCDMA2000_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_plmn_Identity_r11_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_parametersCDMA2000_r11_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_parametersCDMA2000_r11_constr_3, &asn_PER_type_parametersCDMA2000_r11_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_SIB8_PerPLMN_r11_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SIB8_PerPLMN_r11, plmn_Identity_r11),
		...
		0,
		{ &asn_OER_memb_plmn_Identity_r11_constr_2, &asn_PER_memb_plmn_Identity_r11_constr_2,  memb_plmn_Identity_r11_constraint_1 },
		0, 0, /* No default value */
		"plmn-Identity-r11"
		},
