...
static asn_oer_constraints_t asn_OER_memb_subframePattern10_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_subframePattern40_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	40	/* (SIZE(40..40)) */};
...
static asn_oer_constraints_t asn_OER_type_DL_Bitmap_NB_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_DL_Bitmap_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_Bitmap_NB_r13, choice.subframePattern10_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_subframePattern10_r13_constr_2, &asn_PER_memb_subframePattern10_r13_constr_2,  memb_subframePattern10_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_Bitmap_NB_r13, choice.subframePattern40_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_subframePattern40_r13_constr_3, &asn_PER_memb_subframePattern40_r13_constr_3,  memb_subframePattern40_r13_constraint_1 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_DL_Bitmap_NB_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_DL_Bitmap_NB_r13_constr_1, &asn_PER_type_DL_Bitmap_NB_r13_constr_1, CHOICE_constraint },
