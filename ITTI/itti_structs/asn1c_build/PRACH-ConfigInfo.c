...
static asn_oer_constraints_t asn_OER_memb_prach_ConfigIndex_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_zeroCorrelationZoneConfig_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_PRACH_ConfigInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigInfo, prach_ConfigIndex),
		...
		0,
		{ &asn_OER_memb_prach_ConfigIndex_constr_2, &asn_PER_memb_prach_ConfigIndex_constr_2,  memb_prach_ConfigIndex_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigInfo, zeroCorrelationZoneConfig),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_zeroCorrelationZoneConfig_constr_4, &asn_PER_memb_zeroCorrelationZoneConfig_constr_4,  memb_zeroCorrelationZoneConfig_constraint_1 },
		0, 0, /* No default value */
