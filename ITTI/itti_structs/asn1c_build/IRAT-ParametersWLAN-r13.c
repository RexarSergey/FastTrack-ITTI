...
static asn_oer_constraints_t asn_OER_type_supportedBandListWLAN_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_supportedBandListWLAN_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_supportedBandListWLAN_r13_2 = {
	...
	{ &asn_OER_type_supportedBandListWLAN_r13_constr_2, &asn_PER_type_supportedBandListWLAN_r13_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_IRAT_ParametersWLAN_r13_1[] = {
	{ ATF_POINTER, 1, offsetof(struct IRAT_ParametersWLAN_r13, supportedBandListWLAN_r13),
		...
		0,
		{ &asn_OER_memb_supportedBandListWLAN_r13_constr_2, &asn_PER_memb_supportedBandListWLAN_r13_constr_2,  memb_supportedBandListWLAN_r13_constraint_1 },
		0, 0, /* No default value */
		"supportedBandListWLAN-r13"
		},
};
