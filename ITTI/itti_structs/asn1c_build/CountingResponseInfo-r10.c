...
static asn_oer_constraints_t asn_OER_memb_countingResponseService_r10_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CountingResponseInfo_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CountingResponseInfo_r10, countingResponseService_r10),
		...
		0,
		{ &asn_OER_memb_countingResponseService_r10_constr_2, &asn_PER_memb_countingResponseService_r10_constr_2,  memb_countingResponseService_r10_constraint_1 },
