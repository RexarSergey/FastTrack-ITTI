...
static asn_oer_constraints_t asn_OER_type_ac_BarringFactor_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_ac_BarringTime_constr_19 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ac_BarringForSpecialAC_constr_28 CC_NOTUSED = {
	{ 0, 0 },
	5	/* (SIZE(5..5)) */};
...
asn_TYPE_descriptor_t asn_DEF_ac_BarringFactor_2 = {
	...
	{ &asn_OER_type_ac_BarringFactor_constr_2, &asn_PER_type_ac_BarringFactor_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ac_BarringTime_19 = {
	...
	{ &asn_OER_type_ac_BarringTime_constr_19, &asn_PER_type_ac_BarringTime_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_AC_BarringConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AC_BarringConfig, ac_BarringForSpecialAC),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ac_BarringForSpecialAC_constr_28, &asn_PER_memb_ac_BarringForSpecialAC_constr_28,  memb_ac_BarringForSpecialAC_constraint_1 },
		0, 0, /* No default value */
