...
static asn_oer_constraints_t asn_OER_memb_oneFrame_v1430_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_fourFrames_v1430_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_type_subframeAllocation_v1430_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_subframeAllocation_v1430_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig_v1430__subframeAllocation_v1430, choice.oneFrame_v1430),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_oneFrame_v1430_constr_3, &asn_PER_memb_oneFrame_v1430_constr_3,  memb_oneFrame_v1430_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBSFN_SubframeConfig_v1430__subframeAllocation_v1430, choice.fourFrames_v1430),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_fourFrames_v1430_constr_4, &asn_PER_memb_fourFrames_v1430_constr_4,  memb_fourFrames_v1430_constraint_2 },
		0, 0, /* No default value */
		"fourFrames-v1430"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_subframeAllocation_v1430_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_subframeAllocation_v1430_constr_2, &asn_PER_type_subframeAllocation_v1430_constr_2, CHOICE_constraint },
