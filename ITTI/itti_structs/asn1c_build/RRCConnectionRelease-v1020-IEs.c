...
static asn_oer_constraints_t asn_OER_memb_extendedWaitTime_r10_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (1..1800) */,
	-1};
...
asn_TYPE_member_t asn_MBR_RRCConnectionRelease_v1020_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionRelease_v1020_IEs, extendedWaitTime_r10),
		...
		0,
		{ &asn_OER_memb_extendedWaitTime_r10_constr_2, &asn_PER_memb_extendedWaitTime_r10_constr_2,  memb_extendedWaitTime_r10_constraint_1 },
