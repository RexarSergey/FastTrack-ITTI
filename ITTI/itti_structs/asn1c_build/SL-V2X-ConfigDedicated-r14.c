...
static asn_oer_constraints_t asn_OER_memb_mcs_r14_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_commTxResources_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_scheduled_r14_5[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_ConfigDedicated_r14__commTxResources_r14__setup__scheduled_r14, mcs_r14),
		...
		0,
		{ &asn_OER_memb_mcs_r14_constr_9, &asn_PER_memb_mcs_r14_constr_9,  memb_mcs_r14_constraint_5 },
		0, 0, /* No default value */
		"mcs-r14"
		},
...
asn_TYPE_descriptor_t asn_DEF_commTxResources_r14_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_commTxResources_r14_constr_2, &asn_PER_type_commTxResources_r14_constr_2, CHOICE_constraint },
