...
static asn_oer_constraints_t asn_OER_memb_prach_ConfigIndex_r10_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
asn_TYPE_member_t asn_MBR_PRACH_ConfigSCell_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_ConfigSCell_r10, prach_ConfigIndex_r10),
		...
		0,
		{ &asn_OER_memb_prach_ConfigIndex_r10_constr_2, &asn_PER_memb_prach_ConfigIndex_r10_constr_2,  memb_prach_ConfigIndex_r10_constraint_1 },
