...
static asn_oer_constraints_t asn_OER_type_ue_Type_r13_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_carrierFreqDiscTx_r13_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ue_Type_r13_6 = {
	...
	{ &asn_OER_type_ue_Type_r13_constr_6, &asn_PER_type_ue_Type_r13_constr_6, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_discTxResourceReq_v1310_9[] = {
	{ ATF_POINTER, 2, offsetof(struct SidelinkUEInformation_v1310_IEs__discTxResourceReq_v1310, carrierFreqDiscTx_r13),
		...
		0,
		{ &asn_OER_memb_carrierFreqDiscTx_r13_constr_10, &asn_PER_memb_carrierFreqDiscTx_r13_constr_10,  memb_carrierFreqDiscTx_r13_constraint_9 },
		0, 0, /* No default value */
