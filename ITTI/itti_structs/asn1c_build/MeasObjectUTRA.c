...
static asn_oer_constraints_t asn_OER_type_cellsToAddModList_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_cellForWhichToReportCGI_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_cellsToAddModList_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_cellsToAddModList_constr_5, &asn_PER_type_cellsToAddModList_constr_5, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_cellForWhichToReportCGI_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_cellForWhichToReportCGI_constr_8, &asn_PER_type_cellForWhichToReportCGI_constr_8, CHOICE_constraint },
