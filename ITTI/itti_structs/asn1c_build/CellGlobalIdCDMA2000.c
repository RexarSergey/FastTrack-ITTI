...
static asn_oer_constraints_t asn_OER_memb_cellGlobalId1XRTT_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	47	/* (SIZE(47..47)) */};
...
static asn_oer_constraints_t asn_OER_memb_cellGlobalIdHRPD_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	128	/* (SIZE(128..128)) */};
...
static asn_oer_constraints_t asn_OER_type_CellGlobalIdCDMA2000_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_CellGlobalIdCDMA2000_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdCDMA2000, choice.cellGlobalId1XRTT),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_cellGlobalId1XRTT_constr_2, &asn_PER_memb_cellGlobalId1XRTT_constr_2,  memb_cellGlobalId1XRTT_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellGlobalIdCDMA2000, choice.cellGlobalIdHRPD),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_cellGlobalIdHRPD_constr_3, &asn_PER_memb_cellGlobalIdHRPD_constr_3,  memb_cellGlobalIdHRPD_constraint_1 },
		0, 0, /* No default value */
		"cellGlobalIdHRPD"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_CellGlobalIdCDMA2000 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_CellGlobalIdCDMA2000_constr_1, &asn_PER_type_CellGlobalIdCDMA2000_constr_1, CHOICE_constraint },
