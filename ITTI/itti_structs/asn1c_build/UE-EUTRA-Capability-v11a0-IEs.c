...
static asn_oer_constraints_t asn_OER_memb_ue_Category_v11a0_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (11..12) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v11a0_IEs_1[] = {
	{ ATF_POINTER, 3, offsetof(struct UE_EUTRA_Capability_v11a0_IEs, ue_Category_v11a0),
		...
		0,
		{ &asn_OER_memb_ue_Category_v11a0_constr_2, &asn_PER_memb_ue_Category_v11a0_constr_2,  memb_ue_Category_v11a0_constraint_1 },
