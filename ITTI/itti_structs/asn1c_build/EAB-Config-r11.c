...
static asn_oer_constraints_t asn_OER_type_eab_Category_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_eab_BarringBitmap_r11_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
asn_TYPE_descriptor_t asn_DEF_eab_Category_r11_2 = {
	...
	{ &asn_OER_type_eab_Category_r11_constr_2, &asn_PER_type_eab_Category_r11_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_EAB_Config_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EAB_Config_r11, eab_BarringBitmap_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_eab_BarringBitmap_r11_constr_6, &asn_PER_memb_eab_BarringBitmap_r11_constr_6,  memb_eab_BarringBitmap_r11_constraint_1 },
		0, 0, /* No default value */
