...
static asn_oer_constraints_t asn_OER_type_discRxInterest_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_discTxResourceReq_r12_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (1..63) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_discRxInterest_r12_4 = {
	...
	{ &asn_OER_type_discRxInterest_r12_constr_4, &asn_PER_type_discRxInterest_r12_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SidelinkUEInformation_r12_IEs_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SidelinkUEInformation_r12_IEs, discTxResourceReq_r12),
		...
		0,
		{ &asn_OER_memb_discTxResourceReq_r12_constr_6, &asn_PER_memb_discTxResourceReq_r12_constr_6,  memb_discTxResourceReq_r12_constraint_1 },
		0, 0, /* No default value */
