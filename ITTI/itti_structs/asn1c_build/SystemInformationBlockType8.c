...
static asn_oer_constraints_t asn_OER_memb_longCodeState1XRTT_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	42	/* (SIZE(42..42)) */};
...
static asn_oer_constraints_t asn_OER_type_csfb_DualRxTxSupport_r10_constr_18 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_searchWindowSize_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_parameters1XRTT_7[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType8__parameters1XRTT, longCodeState1XRTT),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_longCodeState1XRTT_constr_9, &asn_PER_memb_longCodeState1XRTT_constr_9,  memb_longCodeState1XRTT_constraint_7 },
		0, 0, /* No default value */
		"longCodeState1XRTT"
		},
...
asn_TYPE_descriptor_t asn_DEF_csfb_DualRxTxSupport_r10_18 = {
	...
	{ &asn_OER_type_csfb_DualRxTxSupport_r10_constr_18, &asn_PER_type_csfb_DualRxTxSupport_r10_constr_18, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType8_1[] = {
	...
	{ ATF_POINTER, 11, offsetof(struct SystemInformationBlockType8, searchWindowSize),
		...
		0,
		{ &asn_OER_memb_searchWindowSize_constr_3, &asn_PER_memb_searchWindowSize_constr_3,  memb_searchWindowSize_constraint_1 },
		0, 0, /* No default value */
		"searchWindowSize"
		},
