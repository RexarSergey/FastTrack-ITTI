 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_memb_betaOffset_ACK_Index_MC_r10_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_betaOffset_RI_Index_MC_r10_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_betaOffset_CQI_Index_MC_r10_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_groupHoppingDisabled_r10_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_dmrs_WithOCC_Activated_r10_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_betaOffsetMC_r10_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_ACK_Index_MC_r10),
		...
		0,
		{ &asn_OER_memb_betaOffset_ACK_Index_MC_r10_constr_3, &asn_PER_memb_betaOffset_ACK_Index_MC_r10_constr_3,  memb_betaOffset_ACK_Index_MC_r10_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_RI_Index_MC_r10),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_betaOffset_RI_Index_MC_r10_constr_4, &asn_PER_memb_betaOffset_RI_Index_MC_r10_constr_4,  memb_betaOffset_RI_Index_MC_r10_constraint_2 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_CQI_Index_MC_r10),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_betaOffset_CQI_Index_MC_r10_constr_5, &asn_PER_memb_betaOffset_CQI_Index_MC_r10_constr_5,  memb_betaOffset_CQI_Index_MC_r10_constraint_2 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_groupHoppingDisabled_r10_6 = {
	...
	{ &asn_OER_type_groupHoppingDisabled_r10_constr_6, &asn_PER_type_groupHoppingDisabled_r10_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dmrs_WithOCC_Activated_r10_8 = {
	...
	{ &asn_OER_type_dmrs_WithOCC_Activated_r10_constr_8, &asn_PER_type_dmrs_WithOCC_Activated_r10_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
