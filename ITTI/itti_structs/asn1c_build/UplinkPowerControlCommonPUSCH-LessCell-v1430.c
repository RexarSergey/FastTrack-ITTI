...
static asn_oer_constraints_t asn_OER_memb_p0_Nominal_PeriodicSRS_r14_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p0_Nominal_AperiodicSRS_r14_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UplinkPowerControlCommonPUSCH_LessCell_v1430_1[] = {
	{ ATF_POINTER, 3, offsetof(struct UplinkPowerControlCommonPUSCH_LessCell_v1430, p0_Nominal_PeriodicSRS_r14),
		...
		0,
		{ &asn_OER_memb_p0_Nominal_PeriodicSRS_r14_constr_2, &asn_PER_memb_p0_Nominal_PeriodicSRS_r14_constr_2,  memb_p0_Nominal_PeriodicSRS_r14_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct UplinkPowerControlCommonPUSCH_LessCell_v1430, p0_Nominal_AperiodicSRS_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p0_Nominal_AperiodicSRS_r14_constr_3, &asn_PER_memb_p0_Nominal_AperiodicSRS_r14_constr_3,  memb_p0_Nominal_AperiodicSRS_r14_constraint_1 },
		0, 0, /* No default value */
