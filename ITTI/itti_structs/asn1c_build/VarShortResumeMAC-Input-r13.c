...
static asn_oer_constraints_t asn_OER_memb_resumeDiscriminator_r13_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
asn_TYPE_member_t asn_MBR_VarShortResumeMAC_Input_r13_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VarShortResumeMAC_Input_r13, resumeDiscriminator_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_resumeDiscriminator_r13_constr_5, &asn_PER_memb_resumeDiscriminator_r13_constr_5,  memb_resumeDiscriminator_r13_constraint_1 },
		0, 0, /* No default value */
