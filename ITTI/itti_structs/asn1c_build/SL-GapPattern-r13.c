...
static asn_oer_constraints_t asn_OER_type_gapPeriod_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_gapSubframeBitmap_r13_constr_19 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..10240)) */};
...
asn_TYPE_descriptor_t asn_DEF_gapPeriod_r13_2 = {
	...
	{ &asn_OER_type_gapPeriod_r13_constr_2, &asn_PER_type_gapPeriod_r13_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SL_GapPattern_r13_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_GapPattern_r13, gapSubframeBitmap_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_gapSubframeBitmap_r13_constr_19, &asn_PER_memb_gapSubframeBitmap_r13_constr_19,  memb_gapSubframeBitmap_r13_constraint_1 },
		0, 0, /* No default value */
