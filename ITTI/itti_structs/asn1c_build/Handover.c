...
static asn_oer_constraints_t asn_OER_memb_nas_SecurityParamFromEUTRA_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
asn_TYPE_member_t asn_MBR_Handover_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct Handover, nas_SecurityParamFromEUTRA),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_nas_SecurityParamFromEUTRA_constr_13, &asn_PER_memb_nas_SecurityParamFromEUTRA_constr_13,  memb_nas_SecurityParamFromEUTRA_constraint_1 },
		0, 0, /* No default value */
