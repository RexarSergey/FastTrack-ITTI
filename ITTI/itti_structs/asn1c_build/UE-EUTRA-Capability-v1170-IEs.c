...
static asn_oer_constraints_t asn_OER_memb_ue_Category_v1170_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (9..10) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v1170_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct UE_EUTRA_Capability_v1170_IEs, ue_Category_v1170),
		...
		0,
		{ &asn_OER_memb_ue_Category_v1170_constr_3, &asn_PER_memb_ue_Category_v1170_constr_3,  memb_ue_Category_v1170_constraint_1 },
		0, 0, /* No default value */
		"ue-Category-v1170"
		},
