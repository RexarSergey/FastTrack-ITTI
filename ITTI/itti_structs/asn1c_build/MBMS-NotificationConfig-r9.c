...
static asn_oer_constraints_t asn_OER_type_notificationRepetitionCoeff_r9_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_notificationOffset_r9_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..10) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_notificationSF_Index_r9_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_notificationRepetitionCoeff_r9_2 = {
	...
	{ &asn_OER_type_notificationRepetitionCoeff_r9_constr_2, &asn_PER_type_notificationRepetitionCoeff_r9_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MBMS_NotificationConfig_r9_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBMS_NotificationConfig_r9, notificationOffset_r9),
		...
		0,
		{ &asn_OER_memb_notificationOffset_r9_constr_5, &asn_PER_memb_notificationOffset_r9_constr_5,  memb_notificationOffset_r9_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBMS_NotificationConfig_r9, notificationSF_Index_r9),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_notificationSF_Index_r9_constr_6, &asn_PER_memb_notificationSF_Index_r9_constr_6,  memb_notificationSF_Index_r9_constraint_1 },
		0, 0, /* No default value */
