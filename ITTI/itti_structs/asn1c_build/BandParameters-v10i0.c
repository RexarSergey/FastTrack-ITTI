...
static asn_oer_constraints_t asn_OER_type_bandParametersDL_v10i0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_bandParametersDL_v10i0_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
asn_TYPE_descriptor_t asn_DEF_bandParametersDL_v10i0_2 = {
	...
	{ &asn_OER_type_bandParametersDL_v10i0_constr_2, &asn_PER_type_bandParametersDL_v10i0_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_BandParameters_v10i0_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v10i0, bandParametersDL_v10i0),
		...
		0,
		{ &asn_OER_memb_bandParametersDL_v10i0_constr_2, &asn_PER_memb_bandParametersDL_v10i0_constr_2,  memb_bandParametersDL_v10i0_constraint_1 },
		0, 0, /* No default value */
		"bandParametersDL-v10i0"
		},
};
