...
static asn_oer_constraints_t asn_OER_type_warningMessageSegmentType_r9_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_messageIdentifier_r9_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_serialNumber_r9_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_warningMessageSegmentNumber_r9_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dataCodingScheme_r9_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
asn_TYPE_descriptor_t asn_DEF_warningMessageSegmentType_r9_4 = {
	...
	{ &asn_OER_type_warningMessageSegmentType_r9_constr_4, &asn_PER_type_warningMessageSegmentType_r9_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType12_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType12_r9, messageIdentifier_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_messageIdentifier_r9_constr_2, &asn_PER_memb_messageIdentifier_r9_constr_2,  memb_messageIdentifier_r9_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType12_r9, serialNumber_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_serialNumber_r9_constr_3, &asn_PER_memb_serialNumber_r9_constr_3,  memb_serialNumber_r9_constraint_1 },
		0, 0, /* No default value */
		"serialNumber-r9"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformationBlockType12_r9, warningMessageSegmentNumber_r9),
		...
		0,
		{ &asn_OER_memb_warningMessageSegmentNumber_r9_constr_7, &asn_PER_memb_warningMessageSegmentNumber_r9_constr_7,  memb_warningMessageSegmentNumber_r9_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType12_r9, dataCodingScheme_r9),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_dataCodingScheme_r9_constr_9, &asn_PER_memb_dataCodingScheme_r9_constr_9,  memb_dataCodingScheme_r9_constraint_1 },
		0, 0, /* No default value */
		"dataCodingScheme-r9"
		},
