...
static asn_oer_constraints_t asn_OER_memb_thresholdChannelUtilizationLow_r12_constr_18 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_thresholdChannelUtilizationHigh_r12_constr_19 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_thresholdWLAN_RSSI_Low_r12_constr_26 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_thresholdWLAN_RSSI_High_r12_constr_27 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_offloadPreferenceIndicator_r12_constr_28 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_TYPE_member_t asn_MBR_thresholdChannelUtilization_r12_17[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdChannelUtilization_r12, thresholdChannelUtilizationLow_r12),
		...
		0,
		{ &asn_OER_memb_thresholdChannelUtilizationLow_r12_constr_18, &asn_PER_memb_thresholdChannelUtilizationLow_r12_constr_18,  memb_thresholdChannelUtilizationLow_r12_constraint_17 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdChannelUtilization_r12, thresholdChannelUtilizationHigh_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_thresholdChannelUtilizationHigh_r12_constr_19, &asn_PER_memb_thresholdChannelUtilizationHigh_r12_constr_19,  memb_thresholdChannelUtilizationHigh_r12_constraint_17 },
		0, 0, /* No default value */
...
static asn_TYPE_member_t asn_MBR_thresholdWLAN_RSSI_r12_25[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdWLAN_RSSI_r12, thresholdWLAN_RSSI_Low_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_thresholdWLAN_RSSI_Low_r12_constr_26, &asn_PER_memb_thresholdWLAN_RSSI_Low_r12_constr_26,  memb_thresholdWLAN_RSSI_Low_r12_constraint_25 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_OffloadConfig_r12__thresholdWLAN_RSSI_r12, thresholdWLAN_RSSI_High_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_thresholdWLAN_RSSI_High_r12_constr_27, &asn_PER_memb_thresholdWLAN_RSSI_High_r12_constr_27,  memb_thresholdWLAN_RSSI_High_r12_constraint_25 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_WLAN_OffloadConfig_r12_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct WLAN_OffloadConfig_r12, offloadPreferenceIndicator_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_offloadPreferenceIndicator_r12_constr_28, &asn_PER_memb_offloadPreferenceIndicator_r12_constr_28,  memb_offloadPreferenceIndicator_r12_constraint_1 },
		0, 0, /* No default value */
