...
static asn_oer_constraints_t asn_OER_memb_resourceConfig_r11_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_subframeConfig_r11_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..154) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CSI_IM_Config_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_Config_r11, resourceConfig_r11),
		...
		0,
		{ &asn_OER_memb_resourceConfig_r11_constr_3, &asn_PER_memb_resourceConfig_r11_constr_3,  memb_resourceConfig_r11_constraint_1 },
		0, 0, /* No default value */
		"resourceConfig-r11"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_IM_Config_r11, subframeConfig_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_subframeConfig_r11_constr_4, &asn_PER_memb_subframeConfig_r11_constr_4,  memb_subframeConfig_r11_constraint_1 },
		0, 0, /* No default value */
		"subframeConfig-r11"
		},
	{ ATF_POINTER, 1, offsetof(struct CSI_IM_Config_r11, interferenceMeasRestriction_r13),
