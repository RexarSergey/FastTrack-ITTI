...
static asn_oer_constraints_t asn_OER_memb_routingAreaCode_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_rssi_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_cgi_Info_4[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultGERAN__cgi_Info, routingAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_routingAreaCode_constr_6, &asn_PER_memb_routingAreaCode_constr_6,  memb_routingAreaCode_constraint_4 },
		0, 0, /* No default value */
		"routingAreaCode"
		},
};
...
static asn_TYPE_member_t asn_MBR_measResult_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultGERAN__measResult, rssi),
		...
		0,
		{ &asn_OER_memb_rssi_constr_8, &asn_PER_memb_rssi_constr_8,  memb_rssi_constraint_7 },
		0, 0, /* No default value */
		"rssi"
		},
};
