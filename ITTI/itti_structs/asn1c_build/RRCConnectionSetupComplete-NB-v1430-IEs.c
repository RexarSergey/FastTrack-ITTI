...
static asn_oer_constraints_t asn_OER_type_gummei_Type_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dcn_ID_r14_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_gummei_Type_r14_2 = {
	...
	{ &asn_OER_type_gummei_Type_r14_constr_2, &asn_PER_type_gummei_Type_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_RRCConnectionSetupComplete_NB_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionSetupComplete_NB_v1430_IEs, dcn_ID_r14),
		...
		0,
		{ &asn_OER_memb_dcn_ID_r14_constr_4, &asn_PER_memb_dcn_ID_r14_constr_4,  memb_dcn_ID_r14_constraint_1 },
		0, 0, /* No default value */
		"dcn-ID-r14"
		},
