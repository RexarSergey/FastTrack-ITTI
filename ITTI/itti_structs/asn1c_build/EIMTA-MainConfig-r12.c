...
static asn_oer_constraints_t asn_OER_type_eimta_CommandPeriodicity_r12_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_eimta_CommandSubframeSet_r12_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_type_EIMTA_MainConfig_r12_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_eimta_CommandPeriodicity_r12_5 = {
	...
	{ &asn_OER_type_eimta_CommandPeriodicity_r12_constr_5, &asn_PER_type_eimta_CommandPeriodicity_r12_constr_5, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EIMTA_MainConfig_r12__setup, eimta_CommandSubframeSet_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_eimta_CommandSubframeSet_r12_constr_10, &asn_PER_memb_eimta_CommandSubframeSet_r12_constr_10,  memb_eimta_CommandSubframeSet_r12_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_EIMTA_MainConfig_r12 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_EIMTA_MainConfig_r12_constr_1, &asn_PER_type_EIMTA_MainConfig_r12_constr_1, CHOICE_constraint },
