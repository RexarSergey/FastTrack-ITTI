...
static asn_oer_constraints_t asn_OER_type_nzp_resourceConfigListExt_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..4)) */};
...
static asn_oer_constraints_t asn_OER_type_cdmType_v1430_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_nzp_resourceConfigListExt_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..4)) */};
...
asn_TYPE_descriptor_t asn_DEF_nzp_resourceConfigListExt_r14_2 = {
	...
	{ &asn_OER_type_nzp_resourceConfigListExt_r14_constr_2, &asn_PER_type_nzp_resourceConfigListExt_r14_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_cdmType_v1430_4 = {
	...
	{ &asn_OER_type_cdmType_v1430_constr_4, &asn_PER_type_cdmType_v1430_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigNZP_EMIMO_v1430_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ConfigNZP_EMIMO_v1430, nzp_resourceConfigListExt_r14),
		...
		0,
		{ &asn_OER_memb_nzp_resourceConfigListExt_r14_constr_2, &asn_PER_memb_nzp_resourceConfigListExt_r14_constr_2,  memb_nzp_resourceConfigListExt_r14_constraint_1 },
		0, 0, /* No default value */
		"nzp-resourceConfigListExt-r14"
		},
