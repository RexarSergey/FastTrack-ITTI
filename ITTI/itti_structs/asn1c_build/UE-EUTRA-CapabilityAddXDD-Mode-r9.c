...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndicators_r9_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndRel9Add_r9_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_CapabilityAddXDD_Mode_r9_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_r9, featureGroupIndicators_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndicators_r9_constr_3, &asn_PER_memb_featureGroupIndicators_r9_constr_3,  memb_featureGroupIndicators_r9_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 5, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_r9, featureGroupIndRel9Add_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndRel9Add_r9_constr_4, &asn_PER_memb_featureGroupIndRel9Add_r9_constr_4,  memb_featureGroupIndRel9Add_r9_constraint_1 },
		0, 0, /* No default value */
