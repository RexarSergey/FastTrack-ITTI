...
static asn_oer_constraints_t asn_OER_memb_prb_Num_r12_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_prb_Start_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..99) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_prb_End_r12_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..99) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SL_TF_ResourceConfig_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SL_TF_ResourceConfig_r12, prb_Num_r12),
		...
		0,
		{ &asn_OER_memb_prb_Num_r12_constr_2, &asn_PER_memb_prb_Num_r12_constr_2,  memb_prb_Num_r12_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_TF_ResourceConfig_r12, prb_Start_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_prb_Start_r12_constr_3, &asn_PER_memb_prb_Start_r12_constr_3,  memb_prb_Start_r12_constraint_1 },
		0, 0, /* No default value */
		"prb-Start-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SL_TF_ResourceConfig_r12, prb_End_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_prb_End_r12_constr_4, &asn_PER_memb_prb_End_r12_constr_4,  memb_prb_End_r12_constraint_1 },
		0, 0, /* No default value */
		"prb-End-r12"
		},
