...
static asn_oer_constraints_t asn_OER_memb_delta_RxLevMin_v1350_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..-1) */,
	-1};
...
asn_TYPE_member_t asn_MBR_CellSelectionInfo_NB_v1350_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellSelectionInfo_NB_v1350, delta_RxLevMin_v1350),
		...
		0,
		{ &asn_OER_memb_delta_RxLevMin_v1350_constr_2, &asn_PER_memb_delta_RxLevMin_v1350_constr_2,  memb_delta_RxLevMin_v1350_constraint_1 },
