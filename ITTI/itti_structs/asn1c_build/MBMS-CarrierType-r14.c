...
static asn_oer_constraints_t asn_OER_type_carrierType_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_frameOffset_r14_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_carrierType_r14_2 = {
	...
	{ &asn_OER_type_carrierType_r14_constr_2, &asn_PER_type_carrierType_r14_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MBMS_CarrierType_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MBMS_CarrierType_r14, frameOffset_r14),
		...
		0,
		{ &asn_OER_memb_frameOffset_r14_constr_6, &asn_PER_memb_frameOffset_r14_constr_6,  memb_frameOffset_r14_constraint_1 },
		0, 0, /* No default value */
		"frameOffset-r14"
		},
};
