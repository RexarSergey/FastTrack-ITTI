...
static asn_oer_constraints_t asn_OER_memb_notificationSF_Index_v1430_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (7..10) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MBMS_NotificationConfig_v1430_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MBMS_NotificationConfig_v1430, notificationSF_Index_v1430),
		...
		0,
		{ &asn_OER_memb_notificationSF_Index_v1430_constr_2, &asn_PER_memb_notificationSF_Index_v1430_constr_2,  memb_notificationSF_Index_v1430_constraint_1 },
