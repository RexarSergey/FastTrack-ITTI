...
static asn_oer_constraints_t asn_OER_type_crs_PortsCount_r12_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_p_aList_r12_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..3)) */};
...
static asn_oer_constraints_t asn_OER_memb_p_b_r12_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p_aList_r12_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..3)) */};
...
static asn_oer_constraints_t asn_OER_memb_transmissionModeList_r12_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_resAllocGranularity_r12_constr_13 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_crs_PortsCount_r12_4 = {
	...
	{ &asn_OER_type_crs_PortsCount_r12_constr_4, &asn_PER_type_crs_PortsCount_r12_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_p_aList_r12_10 = {
	...
	{ &asn_OER_type_p_aList_r12_constr_10, &asn_PER_type_p_aList_r12_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_NeighCellsInfo_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, p_b_r12),
		...
		0,
		{ &asn_OER_memb_p_b_r12_constr_3, &asn_PER_memb_p_b_r12_constr_3,  memb_p_b_r12_constraint_1 },
		0, 0, /* No default value */
		"p-b-r12"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, p_aList_r12),
		...
		0,
		{ &asn_OER_memb_p_aList_r12_constr_10, &asn_PER_memb_p_aList_r12_constr_10,  memb_p_aList_r12_constraint_1 },
		0, 0, /* No default value */
		"p-aList-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, transmissionModeList_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_transmissionModeList_r12_constr_12, &asn_PER_memb_transmissionModeList_r12_constr_12,  memb_transmissionModeList_r12_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsInfo_r12, resAllocGranularity_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_resAllocGranularity_r12_constr_13, &asn_PER_memb_resAllocGranularity_r12_constr_13,  memb_resAllocGranularity_r12_constraint_1 },
		0, 0, /* No default value */
