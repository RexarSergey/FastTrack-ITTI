...
static asn_oer_constraints_t asn_OER_memb_carrierFreqDiscTx_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_discTxResourceReq_r13_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..63) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SL_DiscTxResourceReq_r13_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_DiscTxResourceReq_r13, carrierFreqDiscTx_r13),
		...
		0,
		{ &asn_OER_memb_carrierFreqDiscTx_r13_constr_2, &asn_PER_memb_carrierFreqDiscTx_r13_constr_2,  memb_carrierFreqDiscTx_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_DiscTxResourceReq_r13, discTxResourceReq_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_discTxResourceReq_r13_constr_3, &asn_PER_memb_discTxResourceReq_r13_constr_3,  memb_discTxResourceReq_r13_constraint_1 },
		0, 0, /* No default value */
