...
static asn_oer_constraints_t asn_OER_memb_n2TxAntenna_tm8_r9_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_n4TxAntenna_tm8_r9_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_oer_constraints_t asn_OER_type_codebookSubsetRestriction_v920_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_codebookSubsetRestriction_v920_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaInfoDedicated_v920__codebookSubsetRestriction_v920, choice.n2TxAntenna_tm8_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_n2TxAntenna_tm8_r9_constr_3, &asn_PER_memb_n2TxAntenna_tm8_r9_constr_3,  memb_n2TxAntenna_tm8_r9_constraint_2 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaInfoDedicated_v920__codebookSubsetRestriction_v920, choice.n4TxAntenna_tm8_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_n4TxAntenna_tm8_r9_constr_4, &asn_PER_memb_n4TxAntenna_tm8_r9_constr_4,  memb_n4TxAntenna_tm8_r9_constraint_2 },
		0, 0, /* No default value */
		"n4TxAntenna-tm8-r9"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_codebookSubsetRestriction_v920_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_codebookSubsetRestriction_v920_constr_2, &asn_PER_type_codebookSubsetRestriction_v920_constr_2, CHOICE_constraint },
