 ...
 */
static asn_oer_constraints_t asn_OER_type_WLAN_RSSI_Range_r13_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (0..141) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_WLAN_RSSI_Range_r13 = {
	...
	sizeof(asn_DEF_WLAN_RSSI_Range_r13_tags_1)
		/sizeof(asn_DEF_WLAN_RSSI_Range_r13_tags_1[0]), /* 1 */
	{ &asn_OER_type_WLAN_RSSI_Range_r13_constr_1, &asn_PER_type_WLAN_RSSI_Range_r13_constr_1, WLAN_RSSI_Range_r13_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
