...
static asn_oer_constraints_t asn_OER_type_UL_DCCH_MessageType_NB_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_UL_DCCH_MessageType_NB = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_UL_DCCH_MessageType_NB_constr_1, &asn_PER_type_UL_DCCH_MessageType_NB_constr_1, CHOICE_constraint },
