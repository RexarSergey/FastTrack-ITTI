...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndRel9Add_r9_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v9a0_IEs_1[] = {
	{ ATF_POINTER, 4, offsetof(struct UE_EUTRA_Capability_v9a0_IEs, featureGroupIndRel9Add_r9),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndRel9Add_r9_constr_2, &asn_PER_memb_featureGroupIndRel9Add_r9_constr_2,  memb_featureGroupIndRel9Add_r9_constraint_1 },
