...
static asn_oer_constraints_t asn_OER_type_allowedRetxNumberPSSCH_r14_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_minMCS_PSSCH_r14_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_maxMCS_PSSCH_r14_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_minSubChannel_NumberPSSCH_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..20) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_maxSubchannel_NumberPSSCH_r14_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (1..20) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_allowedRetxNumberPSSCH_r14_6 = {
	...
	{ &asn_OER_type_allowedRetxNumberPSSCH_r14_constr_6, &asn_PER_type_allowedRetxNumberPSSCH_r14_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SL_PSSCH_TxParameters_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, minMCS_PSSCH_r14),
		...
		0,
		{ &asn_OER_memb_minMCS_PSSCH_r14_constr_2, &asn_PER_memb_minMCS_PSSCH_r14_constr_2,  memb_minMCS_PSSCH_r14_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, maxMCS_PSSCH_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxMCS_PSSCH_r14_constr_3, &asn_PER_memb_maxMCS_PSSCH_r14_constr_3,  memb_maxMCS_PSSCH_r14_constraint_1 },
		0, 0, /* No default value */
		"maxMCS-PSSCH-r14"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, minSubChannel_NumberPSSCH_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_minSubChannel_NumberPSSCH_r14_constr_4, &asn_PER_memb_minSubChannel_NumberPSSCH_r14_constr_4,  memb_minSubChannel_NumberPSSCH_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, maxSubchannel_NumberPSSCH_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxSubchannel_NumberPSSCH_r14_constr_5, &asn_PER_memb_maxSubchannel_NumberPSSCH_r14_constr_5,  memb_maxSubchannel_NumberPSSCH_r14_constraint_1 },
		0, 0, /* No default value */
