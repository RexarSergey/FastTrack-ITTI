...
static asn_oer_constraints_t asn_OER_memb_p0_NominalPUSCH_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..24) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p0_NominalPUCCH_constr_4 CC_NOTUSED = {
	{ 1, 0 }	/* (-127..-96) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_deltaPreambleMsg3_constr_6 CC_NOTUSED = {
	{ 1, 0 }	/* (-1..6) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UplinkPowerControlCommon_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommon, p0_NominalPUSCH),
		...
		0,
		{ &asn_OER_memb_p0_NominalPUSCH_constr_2, &asn_PER_memb_p0_NominalPUSCH_constr_2,  memb_p0_NominalPUSCH_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommon, p0_NominalPUCCH),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p0_NominalPUCCH_constr_4, &asn_PER_memb_p0_NominalPUCCH_constr_4,  memb_p0_NominalPUCCH_constraint_1 },
		0, 0, /* No default value */
		"p0-NominalPUCCH"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlCommon, deltaPreambleMsg3),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_deltaPreambleMsg3_constr_6, &asn_PER_memb_deltaPreambleMsg3_constr_6,  memb_deltaPreambleMsg3_constraint_1 },
		0, 0, /* No default value */
		"deltaPreambleMsg3"
		},
};
