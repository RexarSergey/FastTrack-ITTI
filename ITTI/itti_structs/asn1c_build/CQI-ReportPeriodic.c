...
static asn_oer_constraints_t asn_OER_memb_k_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_cqi_FormatIndicatorPeriodic_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_cqi_PUCCH_ResourceIndex_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1185) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_cqi_pmi_ConfigIndex_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1023) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ri_ConfigIndex_constr_10 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1023) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_CQI_ReportPeriodic_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_subbandCQI_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportPeriodic__setup__cqi_FormatIndicatorPeriodic__subbandCQI, k),
		...
		0,
		{ &asn_OER_memb_k_constr_9, &asn_PER_memb_k_constr_9,  memb_k_constraint_8 },
...
asn_TYPE_descriptor_t asn_DEF_cqi_FormatIndicatorPeriodic_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_cqi_FormatIndicatorPeriodic_constr_6, &asn_PER_type_cqi_FormatIndicatorPeriodic_constr_6, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportPeriodic__setup, cqi_PUCCH_ResourceIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cqi_PUCCH_ResourceIndex_constr_4, &asn_PER_memb_cqi_PUCCH_ResourceIndex_constr_4,  memb_cqi_PUCCH_ResourceIndex_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportPeriodic__setup, cqi_pmi_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cqi_pmi_ConfigIndex_constr_5, &asn_PER_memb_cqi_pmi_ConfigIndex_constr_5,  memb_cqi_pmi_ConfigIndex_constraint_3 },
		0, 0, /* No default value */
		"cqi-pmi-ConfigIndex"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct CQI_ReportPeriodic__setup, ri_ConfigIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_ri_ConfigIndex_constr_10, &asn_PER_memb_ri_ConfigIndex_constr_10,  memb_ri_ConfigIndex_constraint_3 },
		0, 0, /* No default value */
		"ri-ConfigIndex"
		},
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportPeriodic = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_CQI_ReportPeriodic_constr_1, &asn_PER_type_CQI_ReportPeriodic_constr_1, CHOICE_constraint },
