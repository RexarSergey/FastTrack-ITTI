...
static asn_oer_constraints_t asn_OER_memb_p0_UE_NPUSCH_r13_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UplinkPowerControlDedicated_NB_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UplinkPowerControlDedicated_NB_r13, p0_UE_NPUSCH_r13),
		...
		0,
		{ &asn_OER_memb_p0_UE_NPUSCH_r13_constr_2, &asn_PER_memb_p0_UE_NPUSCH_r13_constr_2,  memb_p0_UE_NPUSCH_r13_constraint_1 },
