...
static asn_oer_constraints_t asn_OER_type_plmn_Identity_perTAC_List_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_plmn_Identity_perTAC_List_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_plmn_Identity_perTAC_List_r11_2 = {
	...
	{ &asn_OER_type_plmn_Identity_perTAC_List_r11_constr_2, &asn_PER_type_plmn_Identity_perTAC_List_r11_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_TrackingAreaCodeList_v1130_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TrackingAreaCodeList_v1130, plmn_Identity_perTAC_List_r11),
		...
		0,
		{ &asn_OER_memb_plmn_Identity_perTAC_List_r11_constr_2, &asn_PER_memb_plmn_Identity_perTAC_List_r11_constr_2,  memb_plmn_Identity_perTAC_List_r11_constraint_1 },
		0, 0, /* No default value */
		"plmn-Identity-perTAC-List-r11"
		},
};
