...
static asn_oer_constraints_t asn_OER_memb_sfn_OffsetResult_r13_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1023) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_frameBoundaryOffsetResult_r13_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-5..4) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_subframeBoundaryOffsetResult_r13_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MeasResultSSTD_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultSSTD_r13, sfn_OffsetResult_r13),
		...
		0,
		{ &asn_OER_memb_sfn_OffsetResult_r13_constr_2, &asn_PER_memb_sfn_OffsetResult_r13_constr_2,  memb_sfn_OffsetResult_r13_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultSSTD_r13, frameBoundaryOffsetResult_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_frameBoundaryOffsetResult_r13_constr_3, &asn_PER_memb_frameBoundaryOffsetResult_r13_constr_3,  memb_frameBoundaryOffsetResult_r13_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultSSTD_r13, subframeBoundaryOffsetResult_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_subframeBoundaryOffsetResult_r13_constr_4, &asn_PER_memb_subframeBoundaryOffsetResult_r13_constr_4,  memb_subframeBoundaryOffsetResult_r13_constraint_1 },
		0, 0, /* No default value */
