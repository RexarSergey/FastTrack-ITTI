...
asn_TYPE_member_t asn_MBR_SL_SyncConfig_r12_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct SL_SyncConfig_r12, txParameters_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct SL_SyncConfig_r12, rxParamsNCell_r12),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct SL_SyncConfig_r12, syncTxPeriodic_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct SL_SyncConfig_r12, syncOffsetIndicator_v1430),
	...
	{ ATF_POINTER, 3, offsetof(struct SL_SyncConfig_r12, gnss_Sync_r14),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfig_r12, syncOffsetIndicator2_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfig_r12, syncOffsetIndicator3_r14),
...
static const int asn_MAP_SL_SyncConfig_r12_oms_1[] = { 3, 4, 5, 6, 7, 8, 9 };
