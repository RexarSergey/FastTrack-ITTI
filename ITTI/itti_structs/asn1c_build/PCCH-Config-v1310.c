...
static asn_oer_constraints_t asn_OER_type_mpdcch_NumRepetition_Paging_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_nB_v1310_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_paging_narrowBands_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..16) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_mpdcch_NumRepetition_Paging_r13_3 = {
	...
	{ &asn_OER_type_mpdcch_NumRepetition_Paging_r13_constr_3, &asn_PER_type_mpdcch_NumRepetition_Paging_r13_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_nB_v1310_13 = {
	...
	{ &asn_OER_type_nB_v1310_constr_13, &asn_PER_type_nB_v1310_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_PCCH_Config_v1310_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config_v1310, paging_narrowBands_r13),
		...
		0,
		{ &asn_OER_memb_paging_narrowBands_r13_constr_2, &asn_PER_memb_paging_narrowBands_r13_constr_2,  memb_paging_narrowBands_r13_constraint_1 },
