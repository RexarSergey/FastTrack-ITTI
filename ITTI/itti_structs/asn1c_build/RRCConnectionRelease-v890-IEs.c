...
static asn_oer_constraints_t asn_OER_memb_lateNonCriticalExtension_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_RRCConnectionRelease_v890_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionRelease_v890_IEs, lateNonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_lateNonCriticalExtension_constr_2, &asn_PER_memb_lateNonCriticalExtension_constr_2,  memb_lateNonCriticalExtension_constraint_1 },
