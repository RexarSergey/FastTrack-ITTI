...
static asn_oer_constraints_t asn_OER_type_countryCode_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_operatingClass_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_countryCode_r13_3 = {
	...
	{ &asn_OER_type_countryCode_r13_constr_3, &asn_PER_type_countryCode_r13_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_WLAN_CarrierInfo_r13_1[] = {
	{ ATF_POINTER, 3, offsetof(struct WLAN_CarrierInfo_r13, operatingClass_r13),
		...
		0,
		{ &asn_OER_memb_operatingClass_r13_constr_2, &asn_PER_memb_operatingClass_r13_constr_2,  memb_operatingClass_r13_constraint_1 },
