...
static asn_oer_constraints_t asn_OER_memb_modifiedMPR_Behavior_r10_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
asn_TYPE_member_t asn_MBR_RF_Parameters_v10f0_1[] = {
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters_v10f0, modifiedMPR_Behavior_r10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_modifiedMPR_Behavior_r10_constr_2, &asn_PER_memb_modifiedMPR_Behavior_r10_constr_2,  memb_modifiedMPR_Behavior_r10_constraint_1 },
