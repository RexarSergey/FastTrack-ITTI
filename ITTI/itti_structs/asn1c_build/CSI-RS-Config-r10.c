...
static asn_oer_constraints_t asn_OER_type_antennaPortsCount_r10_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_resourceConfig_r10_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_subframeConfig_r10_constr_11 CC_NOTUSED = {
	{ 1, 1 }	/* (0..154) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p_C_r10_constr_12 CC_NOTUSED = {
	{ 1, 0 }	/* (-8..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_csi_RS_r10_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_antennaPortsCount_r10_5 = {
	...
	{ &asn_OER_type_antennaPortsCount_r10_constr_5, &asn_PER_type_antennaPortsCount_r10_constr_5, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Config_r10__csi_RS_r10__setup, resourceConfig_r10),
		...
		0,
		{ &asn_OER_memb_resourceConfig_r10_constr_10, &asn_PER_memb_resourceConfig_r10_constr_10,  memb_resourceConfig_r10_constraint_4 },
		0, 0, /* No default value */
		"resourceConfig-r10"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Config_r10__csi_RS_r10__setup, subframeConfig_r10),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_subframeConfig_r10_constr_11, &asn_PER_memb_subframeConfig_r10_constr_11,  memb_subframeConfig_r10_constraint_4 },
		0, 0, /* No default value */
		"subframeConfig-r10"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_Config_r10__csi_RS_r10__setup, p_C_r10),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p_C_r10_constr_12, &asn_PER_memb_p_C_r10_constr_12,  memb_p_C_r10_constraint_4 },
		0, 0, /* No default value */
		"p-C-r10"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_csi_RS_r10_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_csi_RS_r10_constr_2, &asn_PER_type_csi_RS_r10_constr_2, CHOICE_constraint },
