...
static asn_oer_constraints_t asn_OER_memb_maxEnergyDetectionThreshold_r14_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-85..-52) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_energyDetectionThresholdOffset_r14_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-13..20) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_LBT_Config_r14_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LBT_Config_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LBT_Config_r14, choice.maxEnergyDetectionThreshold_r14),
		...
		0,
		{ &asn_OER_memb_maxEnergyDetectionThreshold_r14_constr_2, &asn_PER_memb_maxEnergyDetectionThreshold_r14_constr_2,  memb_maxEnergyDetectionThreshold_r14_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LBT_Config_r14, choice.energyDetectionThresholdOffset_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_energyDetectionThresholdOffset_r14_constr_3, &asn_PER_memb_energyDetectionThresholdOffset_r14_constr_3,  memb_energyDetectionThresholdOffset_r14_constraint_1 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_LBT_Config_r14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LBT_Config_r14_constr_1, &asn_PER_type_LBT_Config_r14_constr_1, CHOICE_constraint },
