...
static asn_oer_constraints_t asn_OER_memb_ra_PreambleIndex_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ra_PRACH_MaskIndex_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_RACH_ConfigDedicated_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_ConfigDedicated, ra_PreambleIndex),
		...
		0,
		{ &asn_OER_memb_ra_PreambleIndex_constr_2, &asn_PER_memb_ra_PreambleIndex_constr_2,  memb_ra_PreambleIndex_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_ConfigDedicated, ra_PRACH_MaskIndex),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_ra_PRACH_MaskIndex_constr_3, &asn_PER_memb_ra_PRACH_MaskIndex_constr_3,  memb_ra_PRACH_MaskIndex_constraint_1 },
		0, 0, /* No default value */
		"ra-PRACH-MaskIndex"
		},
};
