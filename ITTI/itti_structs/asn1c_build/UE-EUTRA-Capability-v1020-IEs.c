...
static asn_oer_constraints_t asn_OER_memb_ue_Category_v1020_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (6..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndRel10_r10_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_Capability_v1020_IEs_1[] = {
	{ ATF_POINTER, 9, offsetof(struct UE_EUTRA_Capability_v1020_IEs, ue_Category_v1020),
		...
		0,
		{ &asn_OER_memb_ue_Category_v1020_constr_2, &asn_PER_memb_ue_Category_v1020_constr_2,  memb_ue_Category_v1020_constraint_1 },
	...
	{ ATF_POINTER, 5, offsetof(struct UE_EUTRA_Capability_v1020_IEs, featureGroupIndRel10_r10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndRel10_r10_constr_6, &asn_PER_memb_featureGroupIndRel10_r10_constr_6,  memb_featureGroupIndRel10_r10_constraint_1 },
		0, 0, /* No default value */
