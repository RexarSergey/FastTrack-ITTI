...
static asn_oer_constraints_t asn_OER_memb_sessionId_r9_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	1	/* (SIZE(1..1)) */};
...
static asn_oer_constraints_t asn_OER_memb_logicalChannelIdentity_r9_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..28) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MBMS_SessionInfo_r9_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MBMS_SessionInfo_r9, sessionId_r9),
		...
		0,
		{ &asn_OER_memb_sessionId_r9_constr_3, &asn_PER_memb_sessionId_r9_constr_3,  memb_sessionId_r9_constraint_1 },
		0, 0, /* No default value */
		"sessionId-r9"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MBMS_SessionInfo_r9, logicalChannelIdentity_r9),
		...
		0,
		{ &asn_OER_memb_logicalChannelIdentity_r9_constr_4, &asn_PER_memb_logicalChannelIdentity_r9_constr_4,  memb_logicalChannelIdentity_r9_constraint_1 },
		0, 0, /* No default value */
