...
static asn_oer_constraints_t asn_OER_type_dedicatedInfoType_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_dedicatedInfoType_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_dedicatedInfoType_constr_2, &asn_PER_type_dedicatedInfoType_constr_2, CHOICE_constraint },
