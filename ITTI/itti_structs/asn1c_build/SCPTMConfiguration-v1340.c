...
static asn_oer_constraints_t asn_OER_memb_p_b_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SCPTMConfiguration_v1340_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SCPTMConfiguration_v1340, p_b_r13),
		...
		0,
		{ &asn_OER_memb_p_b_r13_constr_2, &asn_PER_memb_p_b_r13_constr_2,  memb_p_b_r13_constraint_1 },
