...
static asn_oer_constraints_t asn_OER_memb_featureGroupIndRel10_v1060_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
asn_TYPE_member_t asn_MBR_UE_EUTRA_CapabilityAddXDD_Mode_v1060_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct UE_EUTRA_CapabilityAddXDD_Mode_v1060, featureGroupIndRel10_v1060),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_featureGroupIndRel10_v1060_constr_3, &asn_PER_memb_featureGroupIndRel10_v1060_constr_3,  memb_featureGroupIndRel10_v1060_constraint_1 },
		0, 0, /* No default value */
