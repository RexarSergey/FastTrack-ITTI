 ...
 */
static asn_oer_constraints_t asn_OER_memb_csi_MeasSubframeSets_r12_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_type_csi_SubframePatternConfig_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_altCQI_Table_r12_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportConfig_v1250__csi_SubframePatternConfig_r12__setup, csi_MeasSubframeSets_r12),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_csi_MeasSubframeSets_r12_constr_5, &asn_PER_memb_csi_MeasSubframeSets_r12_constr_5,  memb_csi_MeasSubframeSets_r12_constraint_4 },
...
asn_TYPE_descriptor_t asn_DEF_csi_SubframePatternConfig_r12_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_csi_SubframePatternConfig_r12_constr_2, &asn_PER_type_csi_SubframePatternConfig_r12_constr_2, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_altCQI_Table_r12_8 = {
	...
	{ &asn_OER_type_altCQI_Table_r12_constr_8, &asn_PER_type_altCQI_Table_r12_constr_8, NativeEnumerated_constraint },
