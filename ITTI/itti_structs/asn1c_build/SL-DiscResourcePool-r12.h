...
typedef enum SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR {
	SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR_NOTHING,	/* No components present */
	SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR_release,
	SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR_setup
} SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR;
...
typedef struct SL_DiscResourcePool_r12 {
	...
	struct SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370 {
		SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_PR present;
		union SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370_u {
			NULL_t	 release;
			struct SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370__setup {
				struct SL_DiscResourcePool_r12__txParamsAddNeighFreq_v1370__setup__freqInfo_v1370 {
...
extern asn_TYPE_member_t asn_MBR_SL_DiscResourcePool_r12_1[11];
