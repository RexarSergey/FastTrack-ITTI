...
static asn_oer_constraints_t asn_OER_memb_pdsch_Start_r13_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_cif_InSchedulingCell_r13_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (1..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_schedulingCellInfo_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_other_r13_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13__other_r13, pdsch_Start_r13),
		...
		0,
		{ &asn_OER_memb_pdsch_Start_r13_constr_7, &asn_PER_memb_pdsch_Start_r13_constr_7,  memb_pdsch_Start_r13_constraint_5 },
		0, 0, /* No default value */
		"pdsch-Start-r13"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13__other_r13, cif_InSchedulingCell_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cif_InSchedulingCell_r13_constr_8, &asn_PER_memb_cif_InSchedulingCell_r13_constr_8,  memb_cif_InSchedulingCell_r13_constraint_5 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_schedulingCellInfo_r13_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_schedulingCellInfo_r13_constr_2, &asn_PER_type_schedulingCellInfo_r13_constr_2, CHOICE_constraint },
