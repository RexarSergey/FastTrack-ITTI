...
static asn_oer_constraints_t asn_OER_memb_groupAssignmentPUSCH_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..29) */,
	-1};
...
asn_TYPE_member_t asn_MBR_UL_ReferenceSignalsPUSCH_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_ReferenceSignalsPUSCH, groupAssignmentPUSCH),
		...
		0,
		{ &asn_OER_memb_groupAssignmentPUSCH_constr_3, &asn_PER_memb_groupAssignmentPUSCH_constr_3,  memb_groupAssignmentPUSCH_constraint_1 },
		0, 0, /* No default value */
