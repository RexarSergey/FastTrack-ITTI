...
static asn_oer_constraints_t asn_OER_memb_nPUSCH_Identity_r11_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..509) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_nDMRS_CSH_Identity_r11_constr_6 CC_NOTUSED = {
	{ 2, 1 }	/* (0..509) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_pusch_DMRS_r11_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1130__pusch_DMRS_r11__setup, nPUSCH_Identity_r11),
		...
		0,
		{ &asn_OER_memb_nPUSCH_Identity_r11_constr_5, &asn_PER_memb_nPUSCH_Identity_r11_constr_5,  memb_nPUSCH_Identity_r11_constraint_4 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUSCH_ConfigDedicated_v1130__pusch_DMRS_r11__setup, nDMRS_CSH_Identity_r11),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_nDMRS_CSH_Identity_r11_constr_6, &asn_PER_memb_nDMRS_CSH_Identity_r11_constr_6,  memb_nDMRS_CSH_Identity_r11_constraint_4 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_pusch_DMRS_r11_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_pusch_DMRS_r11_constr_2, &asn_PER_type_pusch_DMRS_r11_constr_2, CHOICE_constraint },
