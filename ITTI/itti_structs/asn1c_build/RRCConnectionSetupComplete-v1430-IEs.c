...
static asn_oer_constraints_t asn_OER_memb_dcn_ID_r14_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
asn_TYPE_member_t asn_MBR_RRCConnectionSetupComplete_v1430_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionSetupComplete_v1430_IEs, dcn_ID_r14),
		...
		0,
		{ &asn_OER_memb_dcn_ID_r14_constr_2, &asn_PER_memb_dcn_ID_r14_constr_2,  memb_dcn_ID_r14_constraint_1 },
