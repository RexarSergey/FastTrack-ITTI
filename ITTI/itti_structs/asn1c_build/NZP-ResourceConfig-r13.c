...
asn_TYPE_member_t asn_MBR_NZP_ResourceConfig_r13_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NZP_ResourceConfig_r13, transmissionComb_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct NZP_ResourceConfig_r13, frequencyDensity_r14),
...
static const int asn_MAP_NZP_ResourceConfig_r13_oms_1[] = { 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_NZP_ResourceConfig_r13_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transmissionComb-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* frequencyDensity-r14 */
};
