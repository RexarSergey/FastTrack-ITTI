...
static asn_oer_constraints_t asn_OER_memb_k_Max_r13_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_n_MaxList_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..7)) */};
...
asn_TYPE_member_t asn_MBR_MIMO_BeamformedCapabilities_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MIMO_BeamformedCapabilities_r13, k_Max_r13),
		...
		0,
		{ &asn_OER_memb_k_Max_r13_constr_2, &asn_PER_memb_k_Max_r13_constr_2,  memb_k_Max_r13_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct MIMO_BeamformedCapabilities_r13, n_MaxList_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_n_MaxList_r13_constr_3, &asn_PER_memb_n_MaxList_r13_constr_3,  memb_n_MaxList_r13_constraint_1 },
		0, 0, /* No default value */
		"n-MaxList-r13"
		},
};
