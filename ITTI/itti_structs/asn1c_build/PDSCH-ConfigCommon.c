...
static asn_oer_constraints_t asn_OER_memb_referenceSignalPower_constr_2 CC_NOTUSED = {
	{ 1, 0 }	/* (-60..50) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_p_b_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
asn_TYPE_member_t asn_MBR_PDSCH_ConfigCommon_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDSCH_ConfigCommon, referenceSignalPower),
		...
		0,
		{ &asn_OER_memb_referenceSignalPower_constr_2, &asn_PER_memb_referenceSignalPower_constr_2,  memb_referenceSignalPower_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDSCH_ConfigCommon, p_b),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_p_b_constr_3, &asn_PER_memb_p_b_constr_3,  memb_p_b_constraint_1 },
		0, 0, /* No default value */
		"p-b"
		},
};
