...
static asn_oer_constraints_t asn_OER_memb_numFreqEffective_r14_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..12) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_numFreqEffectiveReduced_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..12) */,
	-1};
...
asn_TYPE_member_t asn_MBR_RRCConnectionReconfigurationComplete_v1430_IEs_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct RRCConnectionReconfigurationComplete_v1430_IEs, numFreqEffective_r14),
		...
		0,
		{ &asn_OER_memb_numFreqEffective_r14_constr_3, &asn_PER_memb_numFreqEffective_r14_constr_3,  memb_numFreqEffective_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionReconfigurationComplete_v1430_IEs, numFreqEffectiveReduced_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_numFreqEffectiveReduced_r14_constr_4, &asn_PER_memb_numFreqEffectiveReduced_r14_constr_4,  memb_numFreqEffectiveReduced_r14_constraint_1 },
		0, 0, /* No default value */
