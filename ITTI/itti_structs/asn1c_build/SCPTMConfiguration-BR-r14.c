...
static asn_oer_constraints_t asn_OER_memb_p_b_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SCPTMConfiguration_BR_r14_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SCPTMConfiguration_BR_r14, p_b_r14),
		...
		0,
		{ &asn_OER_memb_p_b_r14_constr_4, &asn_PER_memb_p_b_r14_constr_4,  memb_p_b_r14_constraint_1 },
		0, 0, /* No default value */
		"p-b-r14"
		},
