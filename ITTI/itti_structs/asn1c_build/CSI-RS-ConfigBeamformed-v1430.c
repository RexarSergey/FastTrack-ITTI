...
static asn_oer_constraints_t asn_OER_type_csi_RS_ConfigNZP_ApList_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_csi_RS_ConfigNZP_ApList_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_csi_RS_ConfigNZP_ApList_r14_2 = {
	...
	{ &asn_OER_type_csi_RS_ConfigNZP_ApList_r14_constr_2, &asn_PER_type_csi_RS_ConfigNZP_ApList_r14_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigBeamformed_v1430_1[] = {
	{ ATF_POINTER, 3, offsetof(struct CSI_RS_ConfigBeamformed_v1430, csi_RS_ConfigNZP_ApList_r14),
		...
		0,
		{ &asn_OER_memb_csi_RS_ConfigNZP_ApList_r14_constr_2, &asn_PER_memb_csi_RS_ConfigNZP_ApList_r14_constr_2,  memb_csi_RS_ConfigNZP_ApList_r14_constraint_1 },
		0, 0, /* No default value */
		"csi-RS-ConfigNZP-ApList-r14"
		},
