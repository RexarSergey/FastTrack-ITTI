...
static asn_oer_constraints_t asn_OER_type_syncPriority_r14_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_offsetDFN_r14_constr_13 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1000) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_syncPriority_r14_9 = {
	...
	{ &asn_OER_type_syncPriority_r14_constr_9, &asn_PER_type_syncPriority_r14_constr_9, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SL_V2X_PreconfigFreqInfo_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_PreconfigFreqInfo_r14, offsetDFN_r14),
		...
		0,
		{ &asn_OER_memb_offsetDFN_r14_constr_13, &asn_PER_memb_offsetDFN_r14_constr_13,  memb_offsetDFN_r14_constraint_1 },
		0, 0, /* No default value */
		"offsetDFN-r14"
		},
};
