...
static asn_oer_constraints_t asn_OER_memb_tpc_RNTI_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_type_TPC_PDCCH_Config_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TPC_PDCCH_Config__setup, tpc_RNTI),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_tpc_RNTI_constr_4, &asn_PER_memb_tpc_RNTI_constr_4,  memb_tpc_RNTI_constraint_3 },
...
asn_TYPE_descriptor_t asn_DEF_TPC_PDCCH_Config = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_TPC_PDCCH_Config_constr_1, &asn_PER_type_TPC_PDCCH_Config_constr_1, CHOICE_constraint },
