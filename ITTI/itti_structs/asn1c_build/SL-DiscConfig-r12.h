...
typedef enum SL_DiscConfig_r12__discTxResourcesPS_r13_PR {
	SL_DiscConfig_r12__discTxResourcesPS_r13_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discTxResourcesPS_r13_PR_release,
	SL_DiscConfig_r12__discTxResourcesPS_r13_PR_setup
} SL_DiscConfig_r12__discTxResourcesPS_r13_PR;
typedef enum SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR {
	SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR_scheduled_r13,
	SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR_ue_Selected_r13
} SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR;
typedef enum SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR {
	SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR_release,
	SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR_setup
} SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR;
typedef enum SL_DiscConfig_r12__discRxGapConfig_r13_PR {
	SL_DiscConfig_r12__discRxGapConfig_r13_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discRxGapConfig_r13_PR_release,
	SL_DiscConfig_r12__discRxGapConfig_r13_PR_setup
} SL_DiscConfig_r12__discRxGapConfig_r13_PR;
typedef enum SL_DiscConfig_r12__discTxGapConfig_r13_PR {
	SL_DiscConfig_r12__discTxGapConfig_r13_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discTxGapConfig_r13_PR_release,
	SL_DiscConfig_r12__discTxGapConfig_r13_PR_setup
} SL_DiscConfig_r12__discTxGapConfig_r13_PR;
typedef enum SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR {
	SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR_NOTHING,	/* No components present */
	SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR_release,
	SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR_setup
} SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR;
...
typedef struct SL_DiscConfig_r12 {
	...
	struct SL_DiscConfig_r12__discTxResourcesPS_r13 {
		SL_DiscConfig_r12__discTxResourcesPS_r13_PR present;
		union SL_DiscConfig_r12__discTxResourcesPS_r13_u {
			NULL_t	 release;
			struct SL_DiscConfig_r12__discTxResourcesPS_r13__setup {
				SL_DiscConfig_r12__discTxResourcesPS_r13__setup_PR present;
				union SL_DiscConfig_r12__discTxResourcesPS_r13__setup_u {
					SL_DiscTxConfigScheduled_r13_t	 scheduled_r13;
					struct SL_DiscConfig_r12__discTxResourcesPS_r13__setup__ue_Selected_r13 {
	...
	struct SL_DiscConfig_r12__discTxInterFreqInfo_r13 {
		SL_DiscConfig_r12__discTxInterFreqInfo_r13_PR present;
		union SL_DiscConfig_r12__discTxInterFreqInfo_r13_u {
			NULL_t	 release;
			struct SL_DiscConfig_r12__discTxInterFreqInfo_r13__setup {
	...
	struct SL_DiscConfig_r12__discRxGapConfig_r13 {
		SL_DiscConfig_r12__discRxGapConfig_r13_PR present;
		union SL_DiscConfig_r12__discRxGapConfig_r13_u {
			NULL_t	 release;
	...
	struct SL_DiscConfig_r12__discTxGapConfig_r13 {
		SL_DiscConfig_r12__discTxGapConfig_r13_PR present;
		union SL_DiscConfig_r12__discTxGapConfig_r13_u {
			NULL_t	 release;
			SL_GapConfig_r13_t	 setup;
		} choice;
	...
	struct SL_DiscConfig_r12__discSysInfoToReportConfig_r13 {
		SL_DiscConfig_r12__discSysInfoToReportConfig_r13_PR present;
		union SL_DiscConfig_r12__discSysInfoToReportConfig_r13_u {
			NULL_t	 release;
...
extern asn_TYPE_member_t asn_MBR_SL_DiscConfig_r12_1[8];
