...
static asn_oer_constraints_t asn_OER_type_visitedCellId_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_timeSpent_r12_constr_7 CC_NOTUSED = {
	{ 2, 1 }	/* (0..4095) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_visitedCellId_r12_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_visitedCellId_r12_constr_2, &asn_PER_type_visitedCellId_r12_constr_2, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_VisitedCellInfo_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VisitedCellInfo_r12, timeSpent_r12),
		...
		0,
		{ &asn_OER_memb_timeSpent_r12_constr_7, &asn_PER_memb_timeSpent_r12_constr_7,  memb_timeSpent_r12_constraint_1 },
		0, 0, /* No default value */
		"timeSpent-r12"
		},
};
