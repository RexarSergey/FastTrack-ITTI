...
static asn_oer_constraints_t asn_OER_memb_nkaPUCCH_AN_r12_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..2047) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_nkaPUCCH_Param_r12_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_ConfigDedicated_v1250__nkaPUCCH_Param_r12__setup, nkaPUCCH_AN_r12),
		...
		0,
		{ &asn_OER_memb_nkaPUCCH_AN_r12_constr_5, &asn_PER_memb_nkaPUCCH_AN_r12_constr_5,  memb_nkaPUCCH_AN_r12_constraint_4 },
...
asn_TYPE_descriptor_t asn_DEF_nkaPUCCH_Param_r12_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_nkaPUCCH_Param_r12_constr_2, &asn_PER_type_nkaPUCCH_Param_r12_constr_2, CHOICE_constraint },
