...
static asn_oer_constraints_t asn_OER_memb_resourceConfigList_r11_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigZP_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_RS_ConfigZP_r11, resourceConfigList_r11),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_resourceConfigList_r11_constr_3, &asn_PER_memb_resourceConfigList_r11_constr_3,  memb_resourceConfigList_r11_constraint_1 },
		0, 0, /* No default value */
