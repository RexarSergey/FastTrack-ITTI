...
static asn_oer_constraints_t asn_OER_memb_searchWindowSize_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MeasObjectCDMA2000_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct MeasObjectCDMA2000, searchWindowSize),
		...
		0,
		{ &asn_OER_memb_searchWindowSize_constr_4, &asn_PER_memb_searchWindowSize_constr_4,  memb_searchWindowSize_constraint_1 },
		0, 0, /* No default value */
		"searchWindowSize"
		},
