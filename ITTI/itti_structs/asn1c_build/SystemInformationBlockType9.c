...
static asn_oer_constraints_t asn_OER_memb_hnb_Name_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..48)) */};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType9_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType9, hnb_Name),
		...
		0,
		{ &asn_OER_memb_hnb_Name_constr_2, &asn_PER_memb_hnb_Name_constr_2,  memb_hnb_Name_constraint_1 },
