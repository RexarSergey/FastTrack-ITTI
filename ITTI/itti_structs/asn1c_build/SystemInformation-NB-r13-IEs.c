...
static asn_oer_constraints_t asn_OER_type_sib_TypeAndInfo_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
...
static asn_oer_constraints_t asn_OER_memb_sib_TypeAndInfo_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
...
asn_TYPE_descriptor_t asn_DEF_sib_TypeAndInfo_r13_2 = {
	...
	{ &asn_OER_type_sib_TypeAndInfo_r13_constr_2, &asn_PER_type_sib_TypeAndInfo_r13_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformation_NB_r13_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformation_NB_r13_IEs, sib_TypeAndInfo_r13),
		...
		0,
		{ &asn_OER_memb_sib_TypeAndInfo_r13_constr_2, &asn_PER_memb_sib_TypeAndInfo_r13_constr_2,  memb_sib_TypeAndInfo_r13_constraint_1 },
		0, 0, /* No default value */
		"sib-TypeAndInfo-r13"
		},
