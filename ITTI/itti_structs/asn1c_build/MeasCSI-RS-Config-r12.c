...
static asn_oer_constraints_t asn_OER_memb_physCellId_r12_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..503) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_scramblingIdentity_r12_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..503) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_resourceConfig_r12_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_subframeOffset_r12_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..4) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MeasCSI_RS_Config_r12_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasCSI_RS_Config_r12, physCellId_r12),
		...
		0,
		{ &asn_OER_memb_physCellId_r12_constr_3, &asn_PER_memb_physCellId_r12_constr_3,  memb_physCellId_r12_constraint_1 },
		0, 0, /* No default value */
		"physCellId-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MeasCSI_RS_Config_r12, scramblingIdentity_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_scramblingIdentity_r12_constr_4, &asn_PER_memb_scramblingIdentity_r12_constr_4,  memb_scramblingIdentity_r12_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasCSI_RS_Config_r12, resourceConfig_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_resourceConfig_r12_constr_5, &asn_PER_memb_resourceConfig_r12_constr_5,  memb_resourceConfig_r12_constraint_1 },
		0, 0, /* No default value */
		"resourceConfig-r12"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MeasCSI_RS_Config_r12, subframeOffset_r12),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_subframeOffset_r12_constr_6, &asn_PER_memb_subframeOffset_r12_constr_6,  memb_subframeOffset_r12_constraint_1 },
		0, 0, /* No default value */
		"subframeOffset-r12"
		},
